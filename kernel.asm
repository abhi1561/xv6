...
8010003a:	c7 44 24 04 e8 85 10 	movl   $0x801085e8,0x4(%esp)
80100041:	80 
...
80100198:	c7 04 24 ef 85 10 80 	movl   $0x801085ef,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 00 86 10 80 	movl   $0x80108600,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 07 86 10 80 	movl   $0x80108607,(%esp)
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 0e 86 10 80 	movl   $0x8010860e,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec 17 86 10 80 	movl   $0x80108617,-0x14(%ebp)
      for(; *s; s++)
...
8010055f:	c7 04 24 1e 86 10 80 	movl   $0x8010861e,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 2d 86 10 80 	movl   $0x8010862d,(%esp)
...
801005a8:	c7 04 24 2f 86 10 80 	movl   $0x8010862f,(%esp)
...
80100776:	e8 b0 64 00 00       	call   80106c2b <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 a4 64 00 00       	call   80106c2b <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 98 64 00 00       	call   80106c2b <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 8b 64 00 00       	call   80106c2b <uartputc>
  cgaputc(c);
...
80100a87:	c7 44 24 04 33 86 10 	movl   $0x80108633,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
80100a96:	e8 24 44 00 00       	call   80104ebf <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 3b 86 10 	movl   $0x8010863b,0x4(%esp)
80100aa2:	80 
...
80100b6e:	e9 69 03 00 00       	jmp    80100edc <exec+0x3ed>
  ...
  if((pgdir = setupkvm()) == 0)
80100b73:	e8 04 72 00 00       	call   80107d7c <setupkvm>
...
80100c14:	e8 31 75 00 00       	call   8010814a <allocuvm>
...
80100c52:	e8 08 74 00 00       	call   8010805f <loaduvm>
...
80100cc0:	e8 85 74 00 00       	call   8010814a <allocuvm>
...
80100ce5:	e8 90 76 00 00       	call   8010837a <clearpteu>
  sp = sz;
...
80100d74:	e8 c6 77 00 00       	call   8010853f <copyout>
...
80100e1b:	e8 1f 77 00 00       	call   8010853f <copyout>
...
80100ec5:	e8 a3 6f 00 00       	call   80107e6d <switchuvm>
  freevm(oldpgdir);
80100eca:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecd:	89 04 24             	mov    %eax,(%esp)
80100ed0:	e8 0b 74 00 00       	call   801082e0 <freevm>
  return 0;
...
80100ee8:	e8 f3 73 00 00       	call   801082e0 <freevm>
  if(ip){
...
80100f10:	c7 44 24 04 41 86 10 	movl   $0x80108641,0x4(%esp)
80100f17:	80 
...
80100fa0:	7f 0c                	jg     80100fae <filedup+0x28>
    panic("filedup");
80100fa2:	c7 04 24 48 86 10 80 	movl   $0x80108648,(%esp)
...
80100fe8:	7f 0c                	jg     80100ff6 <fileclose+0x28>
    panic("fileclose");
80100fea:	c7 04 24 50 86 10 80 	movl   $0x80108650,(%esp)
...
8010119f:	eb 0c                	jmp    801011ad <fileread+0xba>
  ...
  panic("fileread");
801011a1:	c7 04 24 5a 86 10 80 	movl   $0x8010865a,(%esp)
...
801012ad:	c7 04 24 63 86 10 80 	movl   $0x80108663,(%esp)
...
801012dd:	eb 0c                	jmp    801012eb <filewrite+0x13c>
  ...
  panic("filewrite");
801012df:	c7 04 24 73 86 10 80 	movl   $0x80108673,(%esp)
...
801014c8:	c7 04 24 7d 86 10 80 	movl   $0x8010867d,(%esp)
...
8010155a:	c7 04 24 93 86 10 80 	movl   $0x80108693,(%esp)
...
801015aa:	c7 44 24 04 a6 86 10 	movl   $0x801086a6,0x4(%esp)
801015b1:	80 
...
80101691:	c7 04 24 ad 86 10 80 	movl   $0x801086ad,(%esp)
...
801017e1:	c7 04 24 bf 86 10 80 	movl   $0x801086bf,(%esp)
...
8010186f:	7f 0c                	jg     8010187d <ilock+0x22>
    panic("ilock");
80101871:	c7 04 24 cf 86 10 80 	movl   $0x801086cf,(%esp)
...
80101999:	75 0c                	jne    801019a7 <ilock+0x14c>
      panic("ilock: no type");
8010199b:	c7 04 24 d5 86 10 80 	movl   $0x801086d5,(%esp)
...
801019ca:	7f 0c                	jg     801019d8 <iunlock+0x2f>
    panic("iunlock");
801019cc:	c7 04 24 e4 86 10 80 	movl   $0x801086e4,(%esp)
...
80101a57:	74 0c                	je     80101a65 <iput+0x57>
      panic("iput busy");
80101a59:	c7 04 24 ec 86 10 80 	movl   $0x801086ec,(%esp)
...
80101bf8:	c7 04 24 f6 86 10 80 	movl   $0x801086f6,(%esp)
...
80102090:	c7 04 24 09 87 10 80 	movl   $0x80108709,(%esp)
...
801020cc:	74 0c                	je     801020da <dirlookup+0x5d>
      panic("dirlink read");
801020ce:	c7 04 24 1b 87 10 80 	movl   $0x8010871b,(%esp)
...
801021b1:	74 0c                	je     801021bf <dirlink+0x79>
      panic("dirlink read");
801021b3:	c7 04 24 1b 87 10 80 	movl   $0x8010871b,(%esp)
...
80102228:	74 0c                	je     80102236 <dirlink+0xf0>
    panic("dirlink");
8010222a:	c7 04 24 28 87 10 80 	movl   $0x80108728,(%esp)
...
80102519:	c7 44 24 04 30 87 10 	movl   $0x80108730,0x4(%esp)
80102520:	80 
...
801025c3:	75 0c                	jne    801025d1 <idestart+0x18>
    panic("idestart");
801025c5:	c7 04 24 34 87 10 80 	movl   $0x80108734,(%esp)
...
801027b3:	c7 04 24 3d 87 10 80 	movl   $0x8010873d,(%esp)
...
801027cc:	c7 04 24 51 87 10 80 	movl   $0x80108751,(%esp)
...
801027eb:	c7 04 24 66 87 10 80 	movl   $0x80108766,(%esp)
...
80102900:	c7 04 24 84 87 10 80 	movl   $0x80108784,(%esp)
...
801029ba:	c7 44 24 04 b6 87 10 	movl   $0x801087b6,0x4(%esp)
801029c1:	80 
...
80102a74:	76 0c                	jbe    80102a82 <kfree+0x39>
    panic("kfree");
80102a76:	c7 04 24 bb 87 10 80 	movl   $0x801087bb,(%esp)
...
80102ea5:	c7 04 24 c4 87 10 80 	movl   $0x801087c4,(%esp)
...
80103208:	c7 44 24 04 f0 87 10 	movl   $0x801087f0,0x4(%esp)
8010320f:	80 
...
801034c3:	c7 04 24 f4 87 10 80 	movl   $0x801087f4,(%esp)
...
8010363d:	c7 04 24 03 88 10 80 	movl   $0x80108803,(%esp)
...
80103652:	c7 04 24 19 88 10 80 	movl   $0x80108819,(%esp)
...
80103740:	c7 04 24 34 88 10 80 	movl   $0x80108834,(%esp)
...
8010375b:	e8 bb 33 00 00       	call   80106b1b <uartinit>
  pinit();         // process table
80103760:	e8 6f 0b 00 00       	call   801042d4 <pinit>
  tvinit();        // trap vectors
80103765:	e8 63 2f 00 00       	call   801066cd <tvinit>
  binit();         // buffer cache
...
80103787:	e8 8c 2e 00 00       	call   80106618 <timerinit>
...
801037b2:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801037b5:	e8 96 46 00 00       	call   80107e50 <switchkvm>
  seginit();
801037ba:	e8 0d 40 00 00       	call   801077cc <seginit>
  lapicinit();
...
801037df:	c7 04 24 4b 88 10 80 	movl   $0x8010884b,(%esp)
801037e6:	e8 b5 cb ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801037eb:	e8 51 30 00 00       	call   80106841 <idtinit>
...
801039be:	00 
801039bf:	c7 44 24 04 5c 88 10 	movl   $0x8010885c,0x4(%esp)
801039c6:	80 
...
80103aff:	00 
80103b00:	c7 44 24 04 61 88 10 	movl   $0x80108861,0x4(%esp)
80103b07:	80 
...
80103bdc:	8b 04 85 a4 88 10 80 	mov    -0x7fef775c(,%eax,4),%eax
...
80103c15:	c7 04 24 66 88 10 80 	movl   $0x80108866,(%esp)
...
80103ca8:	c7 04 24 84 88 10 80 	movl   $0x80108884,(%esp)
...
80103fa1:	c7 44 24 04 b8 88 10 	movl   $0x801088b8,0x4(%esp)
80103fa8:	80 
...
801042da:	c7 44 24 04 bd 88 10 	movl   $0x801088bd,0x4(%esp)
801042e1:	80 
...
801043a7:	ba 88 66 10 80       	mov    $0x80106688,%edx
...
80104405:	e8 72 39 00 00       	call   80107d7c <setupkvm>
...
8010441a:	c7 04 24 c4 88 10 80 	movl   $0x801088c4,(%esp)
...
80104440:	e8 8f 3b 00 00       	call   80107fd4 <inituvm>
  p->sz = PGSIZE;
...
801044e0:	00 
801044e1:	c7 44 24 04 dd 88 10 	movl   $0x801088dd,0x4(%esp)
801044e8:	80 
801044e9:	89 04 24             	mov    %eax,(%esp)
801044ec:	e8 63 0e 00 00       	call   80105354 <safestrcpy>
  p->cwd = namei("/");
801044f1:	c7 04 24 e6 88 10 80 	movl   $0x801088e6,(%esp)
...
80104545:	e8 00 3c 00 00       	call   8010814a <allocuvm>
...
8010457f:	e8 a0 3c 00 00       	call   80108224 <deallocuvm>
...
801045a8:	e8 c0 38 00 00       	call   80107e6d <switchuvm>
  return 0;
...
801045ed:	e8 ce 3d 00 00       	call   801083c0 <copyuvm>
...
80104743:	75 0c                	jne    80104751 <exit+0x22>
    panic("init exiting");
80104745:	c7 04 24 e8 88 10 80 	movl   $0x801088e8,(%esp)
...
80104840:	e8 b3 01 00 00       	call   801049f8 <sched>
  panic("zombie exit");
80104845:	c7 04 24 f5 88 10 80 	movl   $0x801088f5,(%esp)
...
801048c7:	e8 14 3a 00 00       	call   801082e0 <freevm>
        p->state = UNUSED;
...
8010499c:	e8 cc 34 00 00       	call   80107e6d <switchuvm>
      p->state = RUNNING;
...
801049c5:	e8 fb 09 00 00       	call   801053c5 <swtch>
      switchkvm();
801049ca:	e8 81 34 00 00       	call   80107e50 <switchkvm>
...
80104a0e:	c7 04 24 01 89 10 80 	movl   $0x80108901,(%esp)
...
80104a29:	74 0c                	je     80104a37 <sched+0x3f>
    panic("sched locks");
80104a2b:	c7 04 24 13 89 10 80 	movl   $0x80108913,(%esp)
...
80104a43:	75 0c                	jne    80104a51 <sched+0x59>
    panic("sched running");
80104a45:	c7 04 24 1f 89 10 80 	movl   $0x8010891f,(%esp)
...
80104a5f:	c7 04 24 2d 89 10 80 	movl   $0x8010892d,(%esp)
...
80104b16:	75 0c                	jne    80104b24 <sleep+0x1c>
    panic("sleep");
80104b18:	c7 04 24 41 89 10 80 	movl   $0x80108941,(%esp)
...
80104b2a:	c7 04 24 47 89 10 80 	movl   $0x80108947,(%esp)
...
80104cd1:	eb 07                	jmp    80104cda <procdump+0x56>
      ...
      state = "???";
80104cd3:	c7 45 ec 58 89 10 80 	movl   $0x80108958,-0x14(%ebp)
...
80104cf5:	c7 04 24 5c 89 10 80 	movl   $0x8010895c,(%esp)
...
80104d3b:	c7 04 24 65 89 10 80 	movl   $0x80108965,(%esp)
...
80104d5a:	75 d4                	jne    80104d30 <procdump+0xac>
    ...
    cprintf("\n");
80104d5c:	c7 04 24 69 89 10 80 	movl   $0x80108969,(%esp)
...
80104e02:	00 
80104e03:	c7 44 24 04 6b 89 10 	movl   $0x8010896b,0x4(%esp)
80104e0a:	80 
...
80104e2b:	00 
80104e2c:	c7 44 24 04 74 89 10 	movl   $0x80108974,0x4(%esp)
80104e33:	80 
...
80104e54:	00 
80104e55:	c7 44 24 04 7d 89 10 	movl   $0x8010897d,0x4(%esp)
80104e5c:	80 
...
80104ef8:	74 0c                	je     80104f06 <acquire+0x26>
    panic("acquire");
80104efa:	c7 04 24 af 89 10 80 	movl   $0x801089af,(%esp)
...
80104f55:	75 0c                	jne    80104f63 <release+0x21>
    panic("release");
80104f57:	c7 04 24 b7 89 10 80 	movl   $0x801089b7,(%esp)
...
8010508c:	c7 04 24 bf 89 10 80 	movl   $0x801089bf,(%esp)
...
801050b5:	79 0c                	jns    801050c3 <popcli+0x4b>
    panic("popcli");
801050b7:	c7 04 24 d6 89 10 80 	movl   $0x801089d6,(%esp)
...
8010555c:	83 f8 16             	cmp    $0x16,%eax
...
801055aa:	c7 04 24 dd 89 10 80 	movl   $0x801089dd,(%esp)
...
801055cf:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(n, &fd) < 0)
801055d2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801055d5:	89 44 24 04          	mov    %eax,0x4(%esp)
801055d9:	8b 45 08             	mov    0x8(%ebp),%eax
801055dc:	89 04 24             	mov    %eax,(%esp)
801055df:	e8 92 fe ff ff       	call   80105476 <argint>
801055e4:	85 c0                	test   %eax,%eax
801055e6:	79 07                	jns    801055ef <argfd+0x23>
    return -1;
801055e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801055ed:	eb 50                	jmp    8010563f <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801055ef:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f2:	85 c0                	test   %eax,%eax
801055f4:	78 21                	js     80105617 <argfd+0x4b>
801055f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801055f9:	83 f8 0f             	cmp    $0xf,%eax
801055fc:	7f 19                	jg     80105617 <argfd+0x4b>
801055fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105604:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105607:	83 c2 08             	add    $0x8,%edx
8010560a:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010560e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105611:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105615:	75 07                	jne    8010561e <argfd+0x52>
    return -1;
80105617:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010561c:	eb 21                	jmp    8010563f <argfd+0x73>
  if(pfd)
8010561e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105622:	74 08                	je     8010562c <argfd+0x60>
    *pfd = fd;
80105624:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105627:	8b 45 0c             	mov    0xc(%ebp),%eax
8010562a:	89 10                	mov    %edx,(%eax)
  if(pf)
8010562c:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105630:	74 08                	je     8010563a <argfd+0x6e>
    *pf = f;
80105632:	8b 45 10             	mov    0x10(%ebp),%eax
80105635:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105638:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105644:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105647:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
8010564e:	eb 30                	jmp    80105680 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105650:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105656:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105659:	83 c2 08             	add    $0x8,%edx
8010565c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105660:	85 c0                	test   %eax,%eax
80105662:	75 18                	jne    8010567c <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105664:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010566a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010566d:	8d 4a 08             	lea    0x8(%edx),%ecx
80105670:	8b 55 08             	mov    0x8(%ebp),%edx
80105673:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105677:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010567a:	eb 0f                	jmp    8010568b <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010567c:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105680:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105684:	7e ca                	jle    80105650 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801056a9:	e8 1e ff ff ff       	call   801055cc <argfd>
801056ae:	85 c0                	test   %eax,%eax
801056b0:	79 07                	jns    801056b9 <sys_dup+0x2c>
    return -1;
801056b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056b7:	eb 29                	jmp    801056e2 <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801056b9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056bc:	89 04 24             	mov    %eax,(%esp)
801056bf:	e8 7d ff ff ff       	call   80105641 <fdalloc>
801056c4:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056c7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056cb:	79 07                	jns    801056d4 <sys_dup+0x47>
    return -1;
801056cd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056d2:	eb 0e                	jmp    801056e2 <sys_dup+0x55>
  filedup(f);
801056d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056d7:	89 04 24             	mov    %eax,(%esp)
801056da:	e8 a7 b8 ff ff       	call   80100f86 <filedup>
  return fd;
...
80105700:	e8 c7 fe ff ff       	call   801055cc <argfd>
80105705:	85 c0                	test   %eax,%eax
80105707:	78 35                	js     8010573e <sys_read+0x5a>
80105709:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010570c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105710:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105717:	e8 5a fd ff ff       	call   80105476 <argint>
8010571c:	85 c0                	test   %eax,%eax
8010571e:	78 1e                	js     8010573e <sys_read+0x5a>
...
80105735:	e8 6a fd ff ff       	call   801054a4 <argptr>
8010573a:	85 c0                	test   %eax,%eax
8010573c:	79 07                	jns    80105745 <sys_read+0x61>
    return -1;
8010573e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105743:	eb 19                	jmp    8010575e <sys_read+0x7a>
...
80105759:	e8 95 b9 ff ff       	call   801010f3 <fileread>
}
8010575e:	c9                   	leave  
8010575f:	c3                   	ret    
...
8010576d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105774:	00 
80105775:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010577c:	e8 4b fe ff ff       	call   801055cc <argfd>
80105781:	85 c0                	test   %eax,%eax
80105783:	78 35                	js     801057ba <sys_write+0x5a>
80105785:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105788:	89 44 24 04          	mov    %eax,0x4(%esp)
8010578c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105793:	e8 de fc ff ff       	call   80105476 <argint>
80105798:	85 c0                	test   %eax,%eax
8010579a:	78 1e                	js     801057ba <sys_write+0x5a>
8010579c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010579f:	89 44 24 08          	mov    %eax,0x8(%esp)
801057a3:	8d 45 ec             	lea    -0x14(%ebp),%eax
801057a6:	89 44 24 04          	mov    %eax,0x4(%esp)
801057aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057b1:	e8 ee fc ff ff       	call   801054a4 <argptr>
801057b6:	85 c0                	test   %eax,%eax
801057b8:	79 07                	jns    801057c1 <sys_write+0x61>
    return -1;
801057ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057bf:	eb 19                	jmp    801057da <sys_write+0x7a>
  return filewrite(f, p, n);
801057c1:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801057c4:	8b 55 ec             	mov    -0x14(%ebp),%edx
801057c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ca:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801057ce:	89 54 24 04          	mov    %edx,0x4(%esp)
801057d2:	89 04 24             	mov    %eax,(%esp)
801057d5:	e8 d5 b9 ff ff       	call   801011af <filewrite>
}
801057da:	c9                   	leave  
801057db:	c3                   	ret    
...
801057df:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
...
8010583a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105841:	00 
80105842:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105849:	e8 7e fd ff ff       	call   801055cc <argfd>
8010584e:	85 c0                	test   %eax,%eax
80105850:	78 1f                	js     80105871 <sys_fstat+0x44>
80105852:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105859:	00 
8010585a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010585d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105861:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105868:	e8 37 fc ff ff       	call   801054a4 <argptr>
8010586d:	85 c0                	test   %eax,%eax
8010586f:	79 07                	jns    80105878 <sys_fstat+0x4b>
    return -1;
80105871:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105876:	eb 12                	jmp    8010588a <sys_fstat+0x5d>
  return filestat(f, st);
80105878:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010587b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587e:	89 54 24 04          	mov    %edx,0x4(%esp)
80105882:	89 04 24             	mov    %eax,(%esp)
80105885:	e8 1a b8 ff ff       	call   801010a4 <filestat>
}
8010588a:	c9                   	leave  
8010588b:	c3                   	ret    
...
80105892:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105895:	89 44 24 04          	mov    %eax,0x4(%esp)
80105899:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058a0:	e8 61 fc ff ff       	call   80105506 <argstr>
801058a5:	85 c0                	test   %eax,%eax
801058a7:	78 17                	js     801058c0 <sys_link+0x34>
801058a9:	8d 45 dc             	lea    -0x24(%ebp),%eax
801058ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801058b0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058b7:	e8 4a fc ff ff       	call   80105506 <argstr>
801058bc:	85 c0                	test   %eax,%eax
801058be:	79 0a                	jns    801058ca <sys_link+0x3e>
    return -1;
801058c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058c5:	e9 42 01 00 00       	jmp    80105a0c <sys_link+0x180>

  begin_op();
801058ca:	e8 41 db ff ff       	call   80103410 <begin_op>
  if((ip = namei(old)) == 0){
801058cf:	8b 45 d8             	mov    -0x28(%ebp),%eax
801058d2:	89 04 24             	mov    %eax,(%esp)
801058d5:	e8 2c cb ff ff       	call   80102406 <namei>
801058da:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058dd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058e1:	75 0f                	jne    801058f2 <sys_link+0x66>
    end_op();
801058e3:	e8 ac db ff ff       	call   80103494 <end_op>
    return -1;
801058e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058ed:	e9 1a 01 00 00       	jmp    80105a0c <sys_link+0x180>
  }

  ilock(ip);
801058f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058f5:	89 04 24             	mov    %eax,(%esp)
801058f8:	e8 5e bf ff ff       	call   8010185b <ilock>
  if(ip->type == T_DIR){
801058fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105900:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105904:	66 83 f8 01          	cmp    $0x1,%ax
80105908:	75 1a                	jne    80105924 <sys_link+0x98>
    iunlockput(ip);
8010590a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010590d:	89 04 24             	mov    %eax,(%esp)
80105910:	e8 ca c1 ff ff       	call   80101adf <iunlockput>
    end_op();
80105915:	e8 7a db ff ff       	call   80103494 <end_op>
    return -1;
8010591a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010591f:	e9 e8 00 00 00       	jmp    80105a0c <sys_link+0x180>
  }

  ip->nlink++;
80105924:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105927:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010592b:	8d 50 01             	lea    0x1(%eax),%edx
8010592e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105931:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105935:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105938:	89 04 24             	mov    %eax,(%esp)
8010593b:	e8 5f bd ff ff       	call   8010169f <iupdate>
  iunlock(ip);
80105940:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105943:	89 04 24             	mov    %eax,(%esp)
80105946:	e8 5e c0 ff ff       	call   801019a9 <iunlock>
...
80105958:	e8 cb ca ff ff       	call   80102428 <nameiparent>
8010595d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105960:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105964:	75 02                	jne    80105968 <sys_link+0xdc>
    goto bad;
80105966:	eb 68                	jmp    801059d0 <sys_link+0x144>
  ilock(dp);
80105968:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010596b:	89 04 24             	mov    %eax,(%esp)
8010596e:	e8 e8 be ff ff       	call   8010185b <ilock>
...
8010597f:	75 20                	jne    801059a1 <sys_link+0x115>
...
80105998:	e8 a9 c7 ff ff       	call   80102146 <dirlink>
8010599d:	85 c0                	test   %eax,%eax
8010599f:	79 0d                	jns    801059ae <sys_link+0x122>
    iunlockput(dp);
801059a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059a4:	89 04 24             	mov    %eax,(%esp)
801059a7:	e8 33 c1 ff ff       	call   80101adf <iunlockput>
    goto bad;
801059ac:	eb 22                	jmp    801059d0 <sys_link+0x144>
  }
  iunlockput(dp);
801059ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059b1:	89 04 24             	mov    %eax,(%esp)
801059b4:	e8 26 c1 ff ff       	call   80101adf <iunlockput>
  iput(ip);
801059b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059bc:	89 04 24             	mov    %eax,(%esp)
801059bf:	e8 4a c0 ff ff       	call   80101a0e <iput>

  end_op();
801059c4:	e8 cb da ff ff       	call   80103494 <end_op>

  return 0;
801059c9:	b8 00 00 00 00       	mov    $0x0,%eax
801059ce:	eb 3c                	jmp    80105a0c <sys_link+0x180>

bad:
  ilock(ip);
801059d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059d3:	89 04 24             	mov    %eax,(%esp)
801059d6:	e8 80 be ff ff       	call   8010185b <ilock>
  ip->nlink--;
801059db:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059de:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801059e2:	8d 50 ff             	lea    -0x1(%eax),%edx
...
801059f2:	e8 a8 bc ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
801059f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fa:	89 04 24             	mov    %eax,(%esp)
801059fd:	e8 dd c0 ff ff       	call   80101adf <iunlockput>
  end_op();
80105a02:	e8 8d da ff ff       	call   80103494 <end_op>
  return -1;
...
80105a11:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105a14:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105a1b:	eb 4b                	jmp    80105a68 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105a1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a20:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105a27:	00 
80105a28:	89 44 24 08          	mov    %eax,0x8(%esp)
80105a2c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105a2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a33:	8b 45 08             	mov    0x8(%ebp),%eax
80105a36:	89 04 24             	mov    %eax,(%esp)
80105a39:	e8 2a c3 ff ff       	call   80101d68 <readi>
80105a3e:	83 f8 10             	cmp    $0x10,%eax
80105a41:	74 0c                	je     80105a4f <isdirempty+0x41>
      panic("isdirempty: readi");
80105a43:	c7 04 24 f9 89 10 80 	movl   $0x801089f9,(%esp)
80105a4a:	e8 eb aa ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105a4f:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105a53:	66 85 c0             	test   %ax,%ax
80105a56:	74 07                	je     80105a5f <isdirempty+0x51>
      return 0;
80105a58:	b8 00 00 00 00       	mov    $0x0,%eax
80105a5d:	eb 1b                	jmp    80105a7a <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a62:	83 c0 10             	add    $0x10,%eax
...
80105a73:	72 a8                	jb     80105a1d <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105a7f:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105a82:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105a85:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a89:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105a90:	e8 71 fa ff ff       	call   80105506 <argstr>
80105a95:	85 c0                	test   %eax,%eax
80105a97:	79 0a                	jns    80105aa3 <sys_unlink+0x27>
    return -1;
80105a99:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a9e:	e9 af 01 00 00       	jmp    80105c52 <sys_unlink+0x1d6>

  begin_op();
80105aa3:	e8 68 d9 ff ff       	call   80103410 <begin_op>
...
80105ab5:	e8 6e c9 ff ff       	call   80102428 <nameiparent>
80105aba:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105abd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ac1:	75 0f                	jne    80105ad2 <sys_unlink+0x56>
    end_op();
80105ac3:	e8 cc d9 ff ff       	call   80103494 <end_op>
    return -1;
80105ac8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105acd:	e9 80 01 00 00       	jmp    80105c52 <sys_unlink+0x1d6>
  }

  ilock(dp);
80105ad2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ad5:	89 04 24             	mov    %eax,(%esp)
80105ad8:	e8 7e bd ff ff       	call   8010185b <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105add:	c7 44 24 04 0b 8a 10 	movl   $0x80108a0b,0x4(%esp)
80105ae4:	80 
80105ae5:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105ae8:	89 04 24             	mov    %eax,(%esp)
80105aeb:	e8 6b c5 ff ff       	call   8010205b <namecmp>
80105af0:	85 c0                	test   %eax,%eax
80105af2:	0f 84 45 01 00 00    	je     80105c3d <sys_unlink+0x1c1>
80105af8:	c7 44 24 04 0d 8a 10 	movl   $0x80108a0d,0x4(%esp)
80105aff:	80 
80105b00:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b03:	89 04 24             	mov    %eax,(%esp)
80105b06:	e8 50 c5 ff ff       	call   8010205b <namecmp>
80105b0b:	85 c0                	test   %eax,%eax
80105b0d:	0f 84 2a 01 00 00    	je     80105c3d <sys_unlink+0x1c1>
    goto bad;
...
80105b27:	e8 51 c5 ff ff       	call   8010207d <dirlookup>
80105b2c:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b2f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b33:	75 05                	jne    80105b3a <sys_unlink+0xbe>
    goto bad;
80105b35:	e9 03 01 00 00       	jmp    80105c3d <sys_unlink+0x1c1>
  ilock(ip);
80105b3a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b3d:	89 04 24             	mov    %eax,(%esp)
80105b40:	e8 16 bd ff ff       	call   8010185b <ilock>

  if(ip->nlink < 1)
80105b45:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b48:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b4c:	66 85 c0             	test   %ax,%ax
80105b4f:	7f 0c                	jg     80105b5d <sys_unlink+0xe1>
    panic("unlink: nlink < 1");
80105b51:	c7 04 24 10 8a 10 80 	movl   $0x80108a10,(%esp)
...
80105b68:	75 1f                	jne    80105b89 <sys_unlink+0x10d>
80105b6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b6d:	89 04 24             	mov    %eax,(%esp)
80105b70:	e8 99 fe ff ff       	call   80105a0e <isdirempty>
80105b75:	85 c0                	test   %eax,%eax
80105b77:	75 10                	jne    80105b89 <sys_unlink+0x10d>
    iunlockput(ip);
80105b79:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b7c:	89 04 24             	mov    %eax,(%esp)
80105b7f:	e8 5b bf ff ff       	call   80101adf <iunlockput>
    goto bad;
80105b84:	e9 b4 00 00 00       	jmp    80105c3d <sys_unlink+0x1c1>
  }
...
80105b9f:	e8 90 f5 ff ff       	call   80105134 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105bc0:	e8 07 c3 ff ff       	call   80101ecc <writei>
80105bc5:	83 f8 10             	cmp    $0x10,%eax
80105bc8:	74 0c                	je     80105bd6 <sys_unlink+0x15a>
    panic("unlink: writei");
80105bca:	c7 04 24 22 8a 10 80 	movl   $0x80108a22,(%esp)
...
80105be1:	75 1c                	jne    80105bff <sys_unlink+0x183>
    dp->nlink--;
...
80105bfa:	e8 a0 ba ff ff       	call   8010169f <iupdate>
  }
  iunlockput(dp);
80105bff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c02:	89 04 24             	mov    %eax,(%esp)
80105c05:	e8 d5 be ff ff       	call   80101adf <iunlockput>
...
80105c21:	e8 79 ba ff ff       	call   8010169f <iupdate>
  iunlockput(ip);
80105c26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c29:	89 04 24             	mov    %eax,(%esp)
80105c2c:	e8 ae be ff ff       	call   80101adf <iunlockput>

  end_op();
80105c31:	e8 5e d8 ff ff       	call   80103494 <end_op>

  return 0;
80105c36:	b8 00 00 00 00       	mov    $0x0,%eax
80105c3b:	eb 15                	jmp    80105c52 <sys_unlink+0x1d6>

bad:
  iunlockput(dp);
80105c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c40:	89 04 24             	mov    %eax,(%esp)
80105c43:	e8 97 be ff ff       	call   80101adf <iunlockput>
  end_op();
80105c48:	e8 47 d8 ff ff       	call   80103494 <end_op>
  return -1;
...
80105c7c:	e8 a7 c7 ff ff       	call   80102428 <nameiparent>
...
80105c9a:	e8 bc bb ff ff       	call   8010185b <ilock>
...
80105cb3:	e8 c5 c3 ff ff       	call   8010207d <dirlookup>
...
80105cc7:	e8 13 be ff ff       	call   80101adf <iunlockput>
    ilock(ip);
80105ccc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ccf:	89 04 24             	mov    %eax,(%esp)
80105cd2:	e8 84 bb ff ff       	call   8010185b <ilock>
...
80105cf9:	e8 e1 bd ff ff       	call   80101adf <iunlockput>
    return 0;
...
80105d62:	e8 38 b9 ff ff       	call   8010169f <iupdate>
...
80105db5:	c7 44 24 04 0d 8a 10 	movl   $0x80108a0d,0x4(%esp)
80105dbc:	80 
80105dbd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dc0:	89 04 24             	mov    %eax,(%esp)
80105dc3:	e8 7e c3 ff ff       	call   80102146 <dirlink>
80105dc8:	85 c0                	test   %eax,%eax
80105dca:	79 0c                	jns    80105dd8 <create+0x184>
      panic("create dots");
80105dcc:	c7 04 24 40 8a 10 80 	movl   $0x80108a40,(%esp)
...
80105e28:	e8 d9 f6 ff ff       	call   80105506 <argstr>
...
80105e8d:	75 6b                	jne    80105efa <sys_open+0xe6>
      end_op();
80105e8f:	e8 00 d6 ff ff       	call   80103494 <end_op>
      return -1;
80105e94:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e99:	e9 10 01 00 00       	jmp    80105fae <sys_open+0x19a>
    }
  } else {
    if((ip = namei(path)) == 0){
80105e9e:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105ea1:	89 04 24             	mov    %eax,(%esp)
80105ea4:	e8 5d c5 ff ff       	call   80102406 <namei>
80105ea9:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105eac:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105eb0:	75 0f                	jne    80105ec1 <sys_open+0xad>
      end_op();
80105eb2:	e8 dd d5 ff ff       	call   80103494 <end_op>
      return -1;
80105eb7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ebc:	e9 ed 00 00 00       	jmp    80105fae <sys_open+0x19a>
    }
    ilock(ip);
80105ec1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ec4:	89 04 24             	mov    %eax,(%esp)
80105ec7:	e8 8f b9 ff ff       	call   8010185b <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105ecc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ecf:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105ed3:	66 83 f8 01          	cmp    $0x1,%ax
80105ed7:	75 21                	jne    80105efa <sys_open+0xe6>
80105ed9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105edc:	85 c0                	test   %eax,%eax
80105ede:	74 1a                	je     80105efa <sys_open+0xe6>
      iunlockput(ip);
80105ee0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee3:	89 04 24             	mov    %eax,(%esp)
80105ee6:	e8 f4 bb ff ff       	call   80101adf <iunlockput>
      end_op();
80105eeb:	e8 a4 d5 ff ff       	call   80103494 <end_op>
      return -1;
80105ef0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ef5:	e9 b4 00 00 00       	jmp    80105fae <sys_open+0x19a>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105efa:	e8 27 b0 ff ff       	call   80100f26 <filealloc>
80105eff:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f02:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f06:	74 14                	je     80105f1c <sys_open+0x108>
80105f08:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f0b:	89 04 24             	mov    %eax,(%esp)
80105f0e:	e8 2e f7 ff ff       	call   80105641 <fdalloc>
80105f13:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105f16:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105f1a:	79 28                	jns    80105f44 <sys_open+0x130>
    if(f)
80105f1c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f20:	74 0b                	je     80105f2d <sys_open+0x119>
      fileclose(f);
80105f22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f25:	89 04 24             	mov    %eax,(%esp)
80105f28:	e8 a1 b0 ff ff       	call   80100fce <fileclose>
    iunlockput(ip);
80105f2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f30:	89 04 24             	mov    %eax,(%esp)
80105f33:	e8 a7 bb ff ff       	call   80101adf <iunlockput>
    end_op();
80105f38:	e8 57 d5 ff ff       	call   80103494 <end_op>
    return -1;
80105f3d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f42:	eb 6a                	jmp    80105fae <sys_open+0x19a>
  }
  iunlock(ip);
80105f44:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f47:	89 04 24             	mov    %eax,(%esp)
80105f4a:	e8 5a ba ff ff       	call   801019a9 <iunlock>
  end_op();
80105f4f:	e8 40 d5 ff ff       	call   80103494 <end_op>

  f->type = FD_INODE;
80105f54:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f57:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f60:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f63:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f66:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f69:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f70:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f73:	83 e0 01             	and    $0x1,%eax
80105f76:	85 c0                	test   %eax,%eax
80105f78:	0f 94 c0             	sete   %al
80105f7b:	89 c2                	mov    %eax,%edx
80105f7d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f80:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105f83:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f86:	83 e0 01             	and    $0x1,%eax
80105f89:	85 c0                	test   %eax,%eax
80105f8b:	75 0a                	jne    80105f97 <sys_open+0x183>
80105f8d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f90:	83 e0 02             	and    $0x2,%eax
80105f93:	85 c0                	test   %eax,%eax
80105f95:	74 07                	je     80105f9e <sys_open+0x18a>
80105f97:	b8 01 00 00 00       	mov    $0x1,%eax
80105f9c:	eb 05                	jmp    80105fa3 <sys_open+0x18f>
80105f9e:	b8 00 00 00 00       	mov    $0x0,%eax
80105fa3:	89 c2                	mov    %eax,%edx
80105fa5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa8:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
80105fb3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105fb6:	e8 55 d4 ff ff       	call   80103410 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80105fbb:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105fbe:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fc2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fc9:	e8 38 f5 ff ff       	call   80105506 <argstr>
80105fce:	85 c0                	test   %eax,%eax
80105fd0:	78 2c                	js     80105ffe <sys_mkdir+0x4e>
80105fd2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fd5:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105fdc:	00 
80105fdd:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105fe4:	00 
80105fe5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105fec:	00 
80105fed:	89 04 24             	mov    %eax,(%esp)
80105ff0:	e8 5f fc ff ff       	call   80105c54 <create>
80105ff5:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ff8:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ffc:	75 0c                	jne    8010600a <sys_mkdir+0x5a>
    end_op();
80105ffe:	e8 91 d4 ff ff       	call   80103494 <end_op>
    return -1;
80106003:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106008:	eb 15                	jmp    8010601f <sys_mkdir+0x6f>
  }
  iunlockput(ip);
8010600a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010600d:	89 04 24             	mov    %eax,(%esp)
80106010:	e8 ca ba ff ff       	call   80101adf <iunlockput>
  end_op();
80106015:	e8 7a d4 ff ff       	call   80103494 <end_op>
  return 0;
...
80106024:	83 ec 38             	sub    $0x38,%esp
  ...
  begin_op();
80106027:	e8 e4 d3 ff ff       	call   80103410 <begin_op>
  if((len=argstr(0, &path)) < 0 ||
8010602c:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010602f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106033:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010603a:	e8 c7 f4 ff ff       	call   80105506 <argstr>
8010603f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106042:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106046:	78 5e                	js     801060a6 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106048:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010604b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010604f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106056:	e8 1b f4 ff ff       	call   80105476 <argint>
  char *path;
  int len;
  int major, minor;
...
8010605d:	78 47                	js     801060a6 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010605f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106062:	89 44 24 04          	mov    %eax,0x4(%esp)
80106066:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010606d:	e8 04 f4 ff ff       	call   80105476 <argint>
  int len;
  int major, minor;
...
80106074:	78 30                	js     801060a6 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106076:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106079:	0f bf c8             	movswl %ax,%ecx
8010607c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010607f:	0f bf d0             	movswl %ax,%edx
80106082:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106085:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106089:	89 54 24 08          	mov    %edx,0x8(%esp)
8010608d:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106094:	00 
80106095:	89 04 24             	mov    %eax,(%esp)
80106098:	e8 b7 fb ff ff       	call   80105c54 <create>
8010609d:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060a4:	75 0c                	jne    801060b2 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
801060a6:	e8 e9 d3 ff ff       	call   80103494 <end_op>
    return -1;
801060ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060b0:	eb 15                	jmp    801060c7 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801060b2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060b5:	89 04 24             	mov    %eax,(%esp)
801060b8:	e8 22 ba ff ff       	call   80101adf <iunlockput>
  end_op();
801060bd:	e8 d2 d3 ff ff       	call   80103494 <end_op>
  return 0;
...
80106171:	81 ec a8 00 00 00    	sub    $0xa8,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80106177:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010617a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010617e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106185:	e8 7c f3 ff ff       	call   80105506 <argstr>
8010618a:	85 c0                	test   %eax,%eax
8010618c:	78 1a                	js     801061a8 <sys_exec+0x3a>
8010618e:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80106194:	89 44 24 04          	mov    %eax,0x4(%esp)
80106198:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010619f:	e8 d2 f2 ff ff       	call   80105476 <argint>
801061a4:	85 c0                	test   %eax,%eax
801061a6:	79 0a                	jns    801061b2 <sys_exec+0x44>
    return -1;
801061a8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061ad:	e9 c8 00 00 00       	jmp    8010627a <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
801061b2:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801061b9:	00 
801061ba:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061c1:	00 
801061c2:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061c8:	89 04 24             	mov    %eax,(%esp)
801061cb:	e8 64 ef ff ff       	call   80105134 <memset>
  for(i=0;; i++){
801061d0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801061d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061da:	83 f8 1f             	cmp    $0x1f,%eax
801061dd:	76 0a                	jbe    801061e9 <sys_exec+0x7b>
      return -1;
801061df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061e4:	e9 91 00 00 00       	jmp    8010627a <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801061e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061ec:	c1 e0 02             	shl    $0x2,%eax
801061ef:	89 c2                	mov    %eax,%edx
801061f1:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801061f7:	01 c2                	add    %eax,%edx
801061f9:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801061ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80106203:	89 14 24             	mov    %edx,(%esp)
80106206:	e8 cf f1 ff ff       	call   801053da <fetchint>
8010620b:	85 c0                	test   %eax,%eax
8010620d:	79 07                	jns    80106216 <sys_exec+0xa8>
      return -1;
8010620f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106214:	eb 64                	jmp    8010627a <sys_exec+0x10c>
    if(uarg == 0){
80106216:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010621c:	85 c0                	test   %eax,%eax
8010621e:	75 26                	jne    80106246 <sys_exec+0xd8>
      argv[i] = 0;
80106220:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106223:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010622a:	00 00 00 00 
      break;
8010622e:	90                   	nop
    }
...
80106232:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
80106238:	89 54 24 04          	mov    %edx,0x4(%esp)
8010623c:	89 04 24             	mov    %eax,(%esp)
8010623f:	e8 ab a8 ff ff       	call   80100aef <exec>
80106244:	eb 34                	jmp    8010627a <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
    ...
    if(fetchstr(uarg, &argv[i]) < 0)
80106246:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010624c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010624f:	c1 e2 02             	shl    $0x2,%edx
80106252:	01 c2                	add    %eax,%edx
80106254:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010625a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010625e:	89 04 24             	mov    %eax,(%esp)
80106261:	e8 ae f1 ff ff       	call   80105414 <fetchstr>
80106266:	85 c0                	test   %eax,%eax
80106268:	79 07                	jns    80106271 <sys_exec+0x103>
      return -1;
8010626a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010626f:	eb 09                	jmp    8010627a <sys_exec+0x10c>
...
80106275:	e9 5d ff ff ff       	jmp    801061d7 <sys_exec+0x69>
  return exec(path, argv);
}
8010627a:	c9                   	leave  
8010627b:	c3                   	ret    
...
80106334:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106336:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106339:	8d 50 04             	lea    0x4(%eax),%edx
8010633c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010633f:	89 02                	mov    %eax,(%edx)
  return 0;
...
8010634b:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010634e:	e8 61 e2 ff ff       	call   801045b4 <fork>
}
80106353:	c9                   	leave  
80106354:	c3                   	ret    
...
80106358:	83 ec 08             	sub    $0x8,%esp
  exit();
8010635b:	e8 cf e3 ff ff       	call   8010472f <exit>
...
8010636a:	83 ec 08             	sub    $0x8,%esp
  return wait();
8010636d:	e8 df e4 ff ff       	call   80104851 <wait>
}
80106372:	c9                   	leave  
80106373:	c3                   	ret    
...
80106388:	e8 e9 f0 ff ff       	call   80105476 <argint>
8010638d:	85 c0                	test   %eax,%eax
8010638f:	79 07                	jns    80106398 <sys_kill+0x24>
    return -1;
80106391:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106396:	eb 0b                	jmp    801063a3 <sys_kill+0x2f>
  return kill(pid);
80106398:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010639b:	89 04 24             	mov    %eax,(%esp)
8010639e:	e8 69 e8 ff ff       	call   80104c0c <kill>
}
801063a3:	c9                   	leave  
801063a4:	c3                   	ret    
...
801063ae:	8b 40 10             	mov    0x10(%eax),%eax
}
801063b1:	5d                   	pop    %ebp
801063b2:	c3                   	ret    
...
801063c7:	e8 aa f0 ff ff       	call   80105476 <argint>
801063cc:	85 c0                	test   %eax,%eax
801063ce:	79 07                	jns    801063d7 <sys_sbrk+0x24>
    return -1;
801063d0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063d5:	eb 24                	jmp    801063fb <sys_sbrk+0x48>
  addr = proc->sz;
...
801063e8:	e8 22 e1 ff ff       	call   8010450f <growproc>
801063ed:	85 c0                	test   %eax,%eax
801063ef:	79 07                	jns    801063f8 <sys_sbrk+0x45>
    return -1;
801063f1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063f6:	eb 03                	jmp    801063fb <sys_sbrk+0x48>
  return addr;
...
80106400:	83 ec 28             	sub    $0x28,%esp
  int n;
  uint ticks0;
...
80106411:	e8 60 f0 ff ff       	call   80105476 <argint>
80106416:	85 c0                	test   %eax,%eax
80106418:	79 07                	jns    80106421 <sys_sleep+0x24>
    return -1;
8010641a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010641f:	eb 6c                	jmp    8010648d <sys_sleep+0x90>
  acquire(&tickslock);
80106421:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
80106428:	e8 b3 ea ff ff       	call   80104ee0 <acquire>
  ticks0 = ticks;
8010642d:	a1 e0 50 11 80       	mov    0x801150e0,%eax
80106432:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106435:	eb 34                	jmp    8010646b <sys_sleep+0x6e>
    if(proc->killed){
80106437:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010643d:	8b 40 24             	mov    0x24(%eax),%eax
80106440:	85 c0                	test   %eax,%eax
80106442:	74 13                	je     80106457 <sys_sleep+0x5a>
      release(&tickslock);
80106444:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
8010644b:	e8 f2 ea ff ff       	call   80104f42 <release>
      return -1;
80106450:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106455:	eb 36                	jmp    8010648d <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106457:	c7 44 24 04 a0 48 11 	movl   $0x801148a0,0x4(%esp)
8010645e:	80 
8010645f:	c7 04 24 e0 50 11 80 	movl   $0x801150e0,(%esp)
80106466:	e8 9d e6 ff ff       	call   80104b08 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010646b:	a1 e0 50 11 80       	mov    0x801150e0,%eax
80106470:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106473:	89 c2                	mov    %eax,%edx
80106475:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106478:	39 c2                	cmp    %eax,%edx
8010647a:	72 bb                	jb     80106437 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010647c:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
80106483:	e8 ba ea ff ff       	call   80104f42 <release>
  return 0;
...
80106492:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
80106495:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
8010649c:	e8 3f ea ff ff       	call   80104ee0 <acquire>
  xticks = ticks;
801064a1:	a1 e0 50 11 80       	mov    0x801150e0,%eax
801064a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801064a9:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801064b0:	e8 8d ea ff ff       	call   80104f42 <release>
  return xticks;
...
801064ce:	e8 a3 ef ff ff       	call   80105476 <argint>
801064d3:	85 c0                	test   %eax,%eax
801064d5:	79 07                	jns    801064de <sys_getproc+0x24>
                return -1;
801064d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064dc:	eb 0b                	jmp    801064e9 <sys_getproc+0x2f>
        return(getproc(sadd));
801064de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064e1:	89 04 24             	mov    %eax,(%esp)
801064e4:	e8 92 e8 ff ff       	call   80104d7b <getproc>
}
801064e9:	c9                   	leave  
801064ea:	c3                   	ret    
...
801064ec:	89 e5                	mov    %esp,%ebp
        while(*p && *p == *q)
801064ee:	eb 08                	jmp    801064f8 <strcmp+0xd>
        p++, q++;
801064f0:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801064f4:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
        while(*p && *p == *q)
801064f8:	8b 45 08             	mov    0x8(%ebp),%eax
801064fb:	0f b6 00             	movzbl (%eax),%eax
801064fe:	84 c0                	test   %al,%al
80106500:	74 10                	je     80106512 <strcmp+0x27>
80106502:	8b 45 08             	mov    0x8(%ebp),%eax
80106505:	0f b6 10             	movzbl (%eax),%edx
80106508:	8b 45 0c             	mov    0xc(%ebp),%eax
8010650b:	0f b6 00             	movzbl (%eax),%eax
8010650e:	38 c2                	cmp    %al,%dl
80106510:	74 de                	je     801064f0 <strcmp+0x5>
        p++, q++;
        return (uchar)*p - (uchar)*q;
80106512:	8b 45 08             	mov    0x8(%ebp),%eax
80106515:	0f b6 00             	movzbl (%eax),%eax
80106518:	0f b6 d0             	movzbl %al,%edx
8010651b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010651e:	0f b6 00             	movzbl (%eax),%eax
80106521:	0f b6 c0             	movzbl %al,%eax
80106524:	29 c2                	sub    %eax,%edx
...
8010653c:	e8 3a e8 ff ff       	call   80104d7b <getproc>
80106541:	89 45 e8             	mov    %eax,-0x18(%ebp)
        num=no;
80106544:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106547:	89 45 f0             	mov    %eax,-0x10(%ebp)
        for (i=0;i<no;i++)
8010654a:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106551:	eb 69                	jmp    801065bc <mygetproc+0x92>
        {
                if (!strcmp(p->name,"badproc"))
80106553:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106556:	83 c0 0e             	add    $0xe,%eax
80106559:	c7 44 24 04 5c 8a 10 	movl   $0x80108a5c,0x4(%esp)
80106560:	80 
80106561:	89 04 24             	mov    %eax,(%esp)
80106564:	e8 82 ff ff ff       	call   801064eb <strcmp>
80106569:	85 c0                	test   %eax,%eax
8010656b:	75 47                	jne    801065b4 <mygetproc+0x8a>
                {
                        *p=*(p+(no-1));
8010656d:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106570:	05 ff ff ff 07       	add    $0x7ffffff,%eax
80106575:	c1 e0 05             	shl    $0x5,%eax
80106578:	89 c2                	mov    %eax,%edx
8010657a:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010657d:	01 c2                	add    %eax,%edx
8010657f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106582:	8b 0a                	mov    (%edx),%ecx
80106584:	89 08                	mov    %ecx,(%eax)
80106586:	8b 4a 04             	mov    0x4(%edx),%ecx
80106589:	89 48 04             	mov    %ecx,0x4(%eax)
8010658c:	8b 4a 08             	mov    0x8(%edx),%ecx
8010658f:	89 48 08             	mov    %ecx,0x8(%eax)
80106592:	8b 4a 0c             	mov    0xc(%edx),%ecx
80106595:	89 48 0c             	mov    %ecx,0xc(%eax)
80106598:	8b 4a 10             	mov    0x10(%edx),%ecx
8010659b:	89 48 10             	mov    %ecx,0x10(%eax)
8010659e:	8b 4a 14             	mov    0x14(%edx),%ecx
801065a1:	89 48 14             	mov    %ecx,0x14(%eax)
801065a4:	8b 4a 18             	mov    0x18(%edx),%ecx
801065a7:	89 48 18             	mov    %ecx,0x18(%eax)
801065aa:	8b 52 1c             	mov    0x1c(%edx),%edx
801065ad:	89 50 1c             	mov    %edx,0x1c(%eax)
                        num--;
801065b0:	83 6d f0 01          	subl   $0x1,-0x10(%ebp)
                }
        p++;
801065b4:	83 45 ec 20          	addl   $0x20,-0x14(%ebp)
                char name[16];
        } *p;
        p= (struct procentry*)sadd;
        no=getproc(sadd);
...
801065bf:	3b 45 e8             	cmp    -0x18(%ebp),%eax
801065c2:	7c 8f                	jl     80106553 <mygetproc+0x29>
                        *p=*(p+(no-1));
                        num--;
                }
        p++;
...
801065cc:	83 ec 28             	sub    $0x28,%esp
	int sadd;
        ...
        if(argint(0, &sadd) < 0)
801065cf:	8d 45 f4             	lea    -0xc(%ebp),%eax
801065d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801065d6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065dd:	e8 94 ee ff ff       	call   80105476 <argint>
801065e2:	85 c0                	test   %eax,%eax
801065e4:	79 07                	jns    801065ed <sys_mygetproc+0x24>
                return -1;
801065e6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065eb:	eb 0b                	jmp    801065f8 <sys_mygetproc+0x2f>
        return(mygetproc(sadd));
801065ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065f0:	89 04 24             	mov    %eax,(%esp)
801065f3:	e8 32 ff ff ff       	call   8010652a <mygetproc>
}
801065f8:	c9                   	leave  
801065f9:	c3                   	ret    
...
80106606:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
8010660a:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010660d:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106611:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106615:	ee                   	out    %al,(%dx)
}
80106616:	c9                   	leave  
80106617:	c3                   	ret    
...
8010661e:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106625:	00 
80106626:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010662d:	e8 c8 ff ff ff       	call   801065fa <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106632:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106639:	00 
8010663a:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106641:	e8 b4 ff ff ff       	call   801065fa <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106646:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010664d:	00 
8010664e:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106655:	e8 a0 ff ff ff       	call   801065fa <outb>
  picenable(IRQ_TIMER);
8010665a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106661:	e8 36 d7 ff ff       	call   80103d9c <picenable>
}
80106666:	c9                   	leave  
80106667:	c3                   	ret    
...
80106669:	06                   	push   %es
  pushl %fs
8010666a:	0f a0                	push   %fs
  pushl %gs
8010666c:	0f a8                	push   %gs
  pushal
8010666e:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010666f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106673:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106675:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106677:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
8010667b:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
8010667d:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
8010667f:	54                   	push   %esp
  call trap
80106680:	e8 d8 01 00 00       	call   8010685d <trap>
  addl $4, %esp
...
80106688:	61                   	popa   
  popl %gs
80106689:	0f a9                	pop    %gs
  popl %fs
8010668b:	0f a1                	pop    %fs
  popl %es
8010668d:	07                   	pop    %es
  popl %ds
8010668e:	1f                   	pop    %ds
...
80106696:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106699:	8b 45 0c             	mov    0xc(%ebp),%eax
8010669c:	83 e8 01             	sub    $0x1,%eax
8010669f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801066a3:	8b 45 08             	mov    0x8(%ebp),%eax
801066a6:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801066aa:	8b 45 08             	mov    0x8(%ebp),%eax
801066ad:	c1 e8 10             	shr    $0x10,%eax
801066b0:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
801066b4:	8d 45 fa             	lea    -0x6(%ebp),%eax
801066b7:	0f 01 18             	lidtl  (%eax)
}
801066ba:	c9                   	leave  
801066bb:	c3                   	ret    
...
801066c2:	0f 20 d0             	mov    %cr2,%eax
801066c5:	89 45 fc             	mov    %eax,-0x4(%ebp)
  return val;
...
801066da:	e9 c3 00 00 00       	jmp    801067a2 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801066df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e2:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
801066e9:	89 c2                	mov    %eax,%edx
801066eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066ee:	66 89 14 c5 e0 48 11 	mov    %dx,-0x7feeb720(,%eax,8)
801066f5:	80 
801066f6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066f9:	66 c7 04 c5 e2 48 11 	movw   $0x8,-0x7feeb71e(,%eax,8)
80106700:	80 08 00 
80106703:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106706:	0f b6 14 c5 e4 48 11 	movzbl -0x7feeb71c(,%eax,8),%edx
8010670d:	80 
8010670e:	83 e2 e0             	and    $0xffffffe0,%edx
80106711:	88 14 c5 e4 48 11 80 	mov    %dl,-0x7feeb71c(,%eax,8)
80106718:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010671b:	0f b6 14 c5 e4 48 11 	movzbl -0x7feeb71c(,%eax,8),%edx
80106722:	80 
80106723:	83 e2 1f             	and    $0x1f,%edx
80106726:	88 14 c5 e4 48 11 80 	mov    %dl,-0x7feeb71c(,%eax,8)
8010672d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106730:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
80106737:	80 
80106738:	83 e2 f0             	and    $0xfffffff0,%edx
8010673b:	83 ca 0e             	or     $0xe,%edx
8010673e:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
80106745:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106748:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
8010674f:	80 
80106750:	83 e2 ef             	and    $0xffffffef,%edx
80106753:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
8010675a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010675d:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
80106764:	80 
80106765:	83 e2 9f             	and    $0xffffff9f,%edx
80106768:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
8010676f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106772:	0f b6 14 c5 e5 48 11 	movzbl -0x7feeb71b(,%eax,8),%edx
80106779:	80 
8010677a:	83 ca 80             	or     $0xffffff80,%edx
8010677d:	88 14 c5 e5 48 11 80 	mov    %dl,-0x7feeb71b(,%eax,8)
80106784:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106787:	8b 04 85 9c b0 10 80 	mov    -0x7fef4f64(,%eax,4),%eax
8010678e:	c1 e8 10             	shr    $0x10,%eax
80106791:	89 c2                	mov    %eax,%edx
80106793:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106796:	66 89 14 c5 e6 48 11 	mov    %dx,-0x7feeb71a(,%eax,8)
8010679d:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010679e:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801067a2:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
801067a9:	0f 8e 30 ff ff ff    	jle    801066df <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801067af:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
801067b4:	66 a3 e0 4a 11 80    	mov    %ax,0x80114ae0
801067ba:	66 c7 05 e2 4a 11 80 	movw   $0x8,0x80114ae2
801067c1:	08 00 
801067c3:	0f b6 05 e4 4a 11 80 	movzbl 0x80114ae4,%eax
801067ca:	83 e0 e0             	and    $0xffffffe0,%eax
801067cd:	a2 e4 4a 11 80       	mov    %al,0x80114ae4
801067d2:	0f b6 05 e4 4a 11 80 	movzbl 0x80114ae4,%eax
801067d9:	83 e0 1f             	and    $0x1f,%eax
801067dc:	a2 e4 4a 11 80       	mov    %al,0x80114ae4
801067e1:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067e8:	83 c8 0f             	or     $0xf,%eax
801067eb:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067f0:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
801067f7:	83 e0 ef             	and    $0xffffffef,%eax
801067fa:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
801067ff:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
80106806:	83 c8 60             	or     $0x60,%eax
80106809:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
8010680e:	0f b6 05 e5 4a 11 80 	movzbl 0x80114ae5,%eax
80106815:	83 c8 80             	or     $0xffffff80,%eax
80106818:	a2 e5 4a 11 80       	mov    %al,0x80114ae5
8010681d:	a1 9c b1 10 80       	mov    0x8010b19c,%eax
80106822:	c1 e8 10             	shr    $0x10,%eax
80106825:	66 a3 e6 4a 11 80    	mov    %ax,0x80114ae6
  
  initlock(&tickslock, "time");
8010682b:	c7 44 24 04 64 8a 10 	movl   $0x80108a64,0x4(%esp)
80106832:	80 
80106833:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
8010683a:	e8 80 e6 ff ff       	call   80104ebf <initlock>
}
8010683f:	c9                   	leave  
80106840:	c3                   	ret    
...
80106844:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106847:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
8010684e:	00 
8010684f:	c7 04 24 e0 48 11 80 	movl   $0x801148e0,(%esp)
80106856:	e8 38 fe ff ff       	call   80106693 <lidt>
}
8010685b:	c9                   	leave  
8010685c:	c3                   	ret    
...
80106863:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106866:	8b 45 08             	mov    0x8(%ebp),%eax
80106869:	8b 40 30             	mov    0x30(%eax),%eax
8010686c:	83 f8 40             	cmp    $0x40,%eax
8010686f:	75 3f                	jne    801068b0 <trap+0x53>
    if(proc->killed)
80106871:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106877:	8b 40 24             	mov    0x24(%eax),%eax
8010687a:	85 c0                	test   %eax,%eax
8010687c:	74 05                	je     80106883 <trap+0x26>
      exit();
8010687e:	e8 ac de ff ff       	call   8010472f <exit>
    proc->tf = tf;
80106883:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106889:	8b 55 08             	mov    0x8(%ebp),%edx
8010688c:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010688f:	e8 a9 ec ff ff       	call   8010553d <syscall>
    if(proc->killed)
80106894:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010689a:	8b 40 24             	mov    0x24(%eax),%eax
8010689d:	85 c0                	test   %eax,%eax
8010689f:	74 0a                	je     801068ab <trap+0x4e>
      exit();
801068a1:	e8 89 de ff ff       	call   8010472f <exit>
    return;
801068a6:	e9 2d 02 00 00       	jmp    80106ad8 <trap+0x27b>
801068ab:	e9 28 02 00 00       	jmp    80106ad8 <trap+0x27b>
  }

  switch(tf->trapno){
801068b0:	8b 45 08             	mov    0x8(%ebp),%eax
801068b3:	8b 40 30             	mov    0x30(%eax),%eax
801068b6:	83 e8 20             	sub    $0x20,%eax
801068b9:	83 f8 1f             	cmp    $0x1f,%eax
801068bc:	0f 87 bc 00 00 00    	ja     8010697e <trap+0x121>
801068c2:	8b 04 85 0c 8b 10 80 	mov    -0x7fef74f4(,%eax,4),%eax
801068c9:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
801068cb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801068d1:	0f b6 00             	movzbl (%eax),%eax
801068d4:	84 c0                	test   %al,%al
801068d6:	75 31                	jne    80106909 <trap+0xac>
      acquire(&tickslock);
801068d8:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
801068df:	e8 fc e5 ff ff       	call   80104ee0 <acquire>
      ticks++;
801068e4:	a1 e0 50 11 80       	mov    0x801150e0,%eax
801068e9:	83 c0 01             	add    $0x1,%eax
801068ec:	a3 e0 50 11 80       	mov    %eax,0x801150e0
      wakeup(&ticks);
801068f1:	c7 04 24 e0 50 11 80 	movl   $0x801150e0,(%esp)
801068f8:	e8 e4 e2 ff ff       	call   80104be1 <wakeup>
      release(&tickslock);
801068fd:	c7 04 24 a0 48 11 80 	movl   $0x801148a0,(%esp)
80106904:	e8 39 e6 ff ff       	call   80104f42 <release>
    }
    lapiceoi();
80106909:	e8 c2 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
8010690e:	e9 41 01 00 00       	jmp    80106a54 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106913:	e8 c6 bd ff ff       	call   801026de <ideintr>
    lapiceoi();
80106918:	e8 b3 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
8010691d:	e9 32 01 00 00       	jmp    80106a54 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106922:	e8 78 c3 ff ff       	call   80102c9f <kbdintr>
    lapiceoi();
80106927:	e8 a4 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
8010692c:	e9 23 01 00 00       	jmp    80106a54 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106931:	e8 97 03 00 00       	call   80106ccd <uartintr>
    lapiceoi();
80106936:	e8 95 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
8010693b:	e9 14 01 00 00       	jmp    80106a54 <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106940:	8b 45 08             	mov    0x8(%ebp),%eax
80106943:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106946:	8b 45 08             	mov    0x8(%ebp),%eax
80106949:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010694d:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106950:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106956:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
8010695c:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106960:	89 54 24 08          	mov    %edx,0x8(%esp)
80106964:	89 44 24 04          	mov    %eax,0x4(%esp)
80106968:	c7 04 24 6c 8a 10 80 	movl   $0x80108a6c,(%esp)
8010696f:	e8 2c 9a ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106974:	e8 57 c5 ff ff       	call   80102ed0 <lapiceoi>
    break;
80106979:	e9 d6 00 00 00       	jmp    80106a54 <trap+0x1f7>
...
80106986:	74 11                	je     80106999 <trap+0x13c>
80106988:	8b 45 08             	mov    0x8(%ebp),%eax
8010698b:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010698f:	0f b7 c0             	movzwl %ax,%eax
80106992:	83 e0 03             	and    $0x3,%eax
80106995:	85 c0                	test   %eax,%eax
80106997:	75 46                	jne    801069df <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106999:	e8 1e fd ff ff       	call   801066bc <rcr2>
8010699e:	8b 55 08             	mov    0x8(%ebp),%edx
801069a1:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
801069a4:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801069ab:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801069ae:	0f b6 ca             	movzbl %dl,%ecx
801069b1:	8b 55 08             	mov    0x8(%ebp),%edx
801069b4:	8b 52 30             	mov    0x30(%edx),%edx
801069b7:	89 44 24 10          	mov    %eax,0x10(%esp)
801069bb:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801069bf:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801069c3:	89 54 24 04          	mov    %edx,0x4(%esp)
801069c7:	c7 04 24 90 8a 10 80 	movl   $0x80108a90,(%esp)
801069ce:	e8 cd 99 ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801069d3:	c7 04 24 c2 8a 10 80 	movl   $0x80108ac2,(%esp)
801069da:	e8 5b 9b ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069df:	e8 d8 fc ff ff       	call   801066bc <rcr2>
801069e4:	89 c2                	mov    %eax,%edx
801069e6:	8b 45 08             	mov    0x8(%ebp),%eax
801069e9:	8b 78 38             	mov    0x38(%eax),%edi
...
801069f2:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801069f5:	0f b6 f0             	movzbl %al,%esi
801069f8:	8b 45 08             	mov    0x8(%ebp),%eax
801069fb:	8b 58 34             	mov    0x34(%eax),%ebx
801069fe:	8b 45 08             	mov    0x8(%ebp),%eax
80106a01:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106a04:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a0a:	83 c0 6c             	add    $0x6c,%eax
80106a0d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a10:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106a16:	8b 40 10             	mov    0x10(%eax),%eax
80106a19:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106a1d:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106a21:	89 74 24 14          	mov    %esi,0x14(%esp)
80106a25:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106a29:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106a2d:	8b 75 e4             	mov    -0x1c(%ebp),%esi
80106a30:	89 74 24 08          	mov    %esi,0x8(%esp)
80106a34:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a38:	c7 04 24 c8 8a 10 80 	movl   $0x80108ac8,(%esp)
80106a3f:	e8 5c 99 ff ff       	call   801003a0 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
...
80106a51:	eb 01                	jmp    80106a54 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106a7b:	75 05                	jne    80106a82 <trap+0x225>
    exit();
80106a7d:	e8 ad dc ff ff       	call   8010472f <exit>
...
80106ad1:	75 05                	jne    80106ad8 <trap+0x27b>
    exit();
80106ad3:	e8 57 dc ff ff       	call   8010472f <exit>
}
80106ad8:	83 c4 3c             	add    $0x3c,%esp
80106adb:	5b                   	pop    %ebx
80106adc:	5e                   	pop    %esi
80106add:	5f                   	pop    %edi
80106ade:	5d                   	pop    %ebp
...
80106ae3:	83 ec 14             	sub    $0x14,%esp
80106ae6:	8b 45 08             	mov    0x8(%ebp),%eax
80106ae9:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106aed:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106af1:	89 c2                	mov    %eax,%edx
80106af3:	ec                   	in     (%dx),%al
80106af4:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106af7:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106afb:	c9                   	leave  
80106afc:	c3                   	ret    
...
80106b09:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106b0d:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106b10:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106b14:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106b18:	ee                   	out    %al,(%dx)
}
80106b19:	c9                   	leave  
80106b1a:	c3                   	ret    
...
80106b28:	00 
80106b29:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b30:	e8 c8 ff ff ff       	call   80106afd <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106b35:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106b3c:	00 
80106b3d:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b44:	e8 b4 ff ff ff       	call   80106afd <outb>
  outb(COM1+0, 115200/9600);
80106b49:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106b50:	00 
80106b51:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b58:	e8 a0 ff ff ff       	call   80106afd <outb>
  outb(COM1+1, 0);
80106b5d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b64:	00 
80106b65:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b6c:	e8 8c ff ff ff       	call   80106afd <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106b71:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106b78:	00 
80106b79:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b80:	e8 78 ff ff ff       	call   80106afd <outb>
  outb(COM1+4, 0);
80106b85:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b8c:	00 
80106b8d:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b94:	e8 64 ff ff ff       	call   80106afd <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b99:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106ba0:	00 
80106ba1:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ba8:	e8 50 ff ff ff       	call   80106afd <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106bad:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106bb4:	e8 27 ff ff ff       	call   80106ae0 <inb>
80106bb9:	3c ff                	cmp    $0xff,%al
80106bbb:	75 02                	jne    80106bbf <uartinit+0xa4>
    return;
80106bbd:	eb 6a                	jmp    80106c29 <uartinit+0x10e>
  uart = 1;
80106bbf:	c7 05 4c b6 10 80 01 	movl   $0x1,0x8010b64c
80106bc6:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106bc9:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106bd0:	e8 0b ff ff ff       	call   80106ae0 <inb>
  inb(COM1+0);
80106bd5:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106bdc:	e8 ff fe ff ff       	call   80106ae0 <inb>
  picenable(IRQ_COM1);
80106be1:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106be8:	e8 af d1 ff ff       	call   80103d9c <picenable>
  ioapicenable(IRQ_COM1, 0);
80106bed:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106bf4:	00 
80106bf5:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106bfc:	e8 5c bd ff ff       	call   8010295d <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106c01:	c7 45 f4 8c 8b 10 80 	movl   $0x80108b8c,-0xc(%ebp)
80106c08:	eb 15                	jmp    80106c1f <uartinit+0x104>
    uartputc(*p);
...
80106c16:	e8 10 00 00 00       	call   80106c2b <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106c22:	0f b6 00             	movzbl (%eax),%eax
80106c25:	84 c0                	test   %al,%al
80106c27:	75 e1                	jne    80106c0a <uartinit+0xef>
    uartputc(*p);
}
80106c29:	c9                   	leave  
80106c2a:	c3                   	ret    
...
80106c2e:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
80106c31:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106c36:	85 c0                	test   %eax,%eax
80106c38:	75 02                	jne    80106c3c <uartputc+0x11>
    return;
80106c3a:	eb 4b                	jmp    80106c87 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106c3c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106c43:	eb 10                	jmp    80106c55 <uartputc+0x2a>
    microdelay(10);
80106c45:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106c4c:	e8 a4 c2 ff ff       	call   80102ef5 <microdelay>
{
  int i;
...
80106c59:	7f 16                	jg     80106c71 <uartputc+0x46>
80106c5b:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c62:	e8 79 fe ff ff       	call   80106ae0 <inb>
80106c67:	0f b6 c0             	movzbl %al,%eax
80106c6a:	83 e0 20             	and    $0x20,%eax
80106c6d:	85 c0                	test   %eax,%eax
80106c6f:	74 d4                	je     80106c45 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106c71:	8b 45 08             	mov    0x8(%ebp),%eax
80106c74:	0f b6 c0             	movzbl %al,%eax
80106c77:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c7b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c82:	e8 76 fe ff ff       	call   80106afd <outb>
}
80106c87:	c9                   	leave  
80106c88:	c3                   	ret    
...
80106c8c:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c8f:	a1 4c b6 10 80       	mov    0x8010b64c,%eax
80106c94:	85 c0                	test   %eax,%eax
80106c96:	75 07                	jne    80106c9f <uartgetc+0x16>
    return -1;
80106c98:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c9d:	eb 2c                	jmp    80106ccb <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106c9f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106ca6:	e8 35 fe ff ff       	call   80106ae0 <inb>
80106cab:	0f b6 c0             	movzbl %al,%eax
80106cae:	83 e0 01             	and    $0x1,%eax
80106cb1:	85 c0                	test   %eax,%eax
80106cb3:	75 07                	jne    80106cbc <uartgetc+0x33>
    return -1;
80106cb5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106cba:	eb 0f                	jmp    80106ccb <uartgetc+0x42>
  return inb(COM1+0);
80106cbc:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106cc3:	e8 18 fe ff ff       	call   80106ae0 <inb>
...
80106cd3:	c7 04 24 89 6c 10 80 	movl   $0x80106c89,(%esp)
80106cda:	e8 ce 9a ff ff       	call   801007ad <consoleintr>
}
80106cdf:	c9                   	leave  
80106ce0:	c3                   	ret    
...
80106ce3:	6a 00                	push   $0x0
  jmp alltraps
80106ce5:	e9 7e f9 ff ff       	jmp    80106668 <alltraps>
...
80106cec:	6a 01                	push   $0x1
  jmp alltraps
80106cee:	e9 75 f9 ff ff       	jmp    80106668 <alltraps>
...
80106cf3:	6a 00                	push   $0x0
  pushl $2
80106cf5:	6a 02                	push   $0x2
  jmp alltraps
80106cf7:	e9 6c f9 ff ff       	jmp    80106668 <alltraps>
...
80106cfc:	6a 00                	push   $0x0
  pushl $3
80106cfe:	6a 03                	push   $0x3
  jmp alltraps
80106d00:	e9 63 f9 ff ff       	jmp    80106668 <alltraps>
...
80106d05:	6a 00                	push   $0x0
  pushl $4
80106d07:	6a 04                	push   $0x4
  jmp alltraps
80106d09:	e9 5a f9 ff ff       	jmp    80106668 <alltraps>
...
80106d0e:	6a 00                	push   $0x0
  pushl $5
80106d10:	6a 05                	push   $0x5
  jmp alltraps
80106d12:	e9 51 f9 ff ff       	jmp    80106668 <alltraps>
...
80106d17:	6a 00                	push   $0x0
  pushl $6
80106d19:	6a 06                	push   $0x6
  jmp alltraps
80106d1b:	e9 48 f9 ff ff       	jmp    80106668 <alltraps>
...
80106d20:	6a 00                	push   $0x0
  pushl $7
80106d22:	6a 07                	push   $0x7
  jmp alltraps
80106d24:	e9 3f f9 ff ff       	jmp    80106668 <alltraps>

80106d29 <vector8>:
.globl vector8
vector8:
  pushl $8
80106d29:	6a 08                	push   $0x8
  jmp alltraps
80106d2b:	e9 38 f9 ff ff       	jmp    80106668 <alltraps>
...
80106d30:	6a 00                	push   $0x0
  pushl $9
80106d32:	6a 09                	push   $0x9
  jmp alltraps
80106d34:	e9 2f f9 ff ff       	jmp    80106668 <alltraps>

80106d39 <vector10>:
.globl vector10
vector10:
  pushl $10
80106d39:	6a 0a                	push   $0xa
  jmp alltraps
80106d3b:	e9 28 f9 ff ff       	jmp    80106668 <alltraps>

80106d40 <vector11>:
.globl vector11
vector11:
  pushl $11
80106d40:	6a 0b                	push   $0xb
  jmp alltraps
80106d42:	e9 21 f9 ff ff       	jmp    80106668 <alltraps>

80106d47 <vector12>:
.globl vector12
vector12:
  pushl $12
80106d47:	6a 0c                	push   $0xc
  jmp alltraps
80106d49:	e9 1a f9 ff ff       	jmp    80106668 <alltraps>

80106d4e <vector13>:
.globl vector13
vector13:
  pushl $13
80106d4e:	6a 0d                	push   $0xd
  jmp alltraps
80106d50:	e9 13 f9 ff ff       	jmp    80106668 <alltraps>

80106d55 <vector14>:
.globl vector14
vector14:
  pushl $14
80106d55:	6a 0e                	push   $0xe
  jmp alltraps
80106d57:	e9 0c f9 ff ff       	jmp    80106668 <alltraps>
...
80106d5c:	6a 00                	push   $0x0
  pushl $15
80106d5e:	6a 0f                	push   $0xf
  jmp alltraps
80106d60:	e9 03 f9 ff ff       	jmp    80106668 <alltraps>
...
80106d67:	6a 10                	push   $0x10
  jmp alltraps
80106d69:	e9 fa f8 ff ff       	jmp    80106668 <alltraps>

80106d6e <vector17>:
.globl vector17
vector17:
  pushl $17
80106d6e:	6a 11                	push   $0x11
  jmp alltraps
80106d70:	e9 f3 f8 ff ff       	jmp    80106668 <alltraps>
...
80106d75:	6a 00                	push   $0x0
  pushl $18
80106d77:	6a 12                	push   $0x12
  jmp alltraps
80106d79:	e9 ea f8 ff ff       	jmp    80106668 <alltraps>
...
80106d7e:	6a 00                	push   $0x0
  pushl $19
80106d80:	6a 13                	push   $0x13
  jmp alltraps
80106d82:	e9 e1 f8 ff ff       	jmp    80106668 <alltraps>
...
80106d87:	6a 00                	push   $0x0
  pushl $20
80106d89:	6a 14                	push   $0x14
  jmp alltraps
80106d8b:	e9 d8 f8 ff ff       	jmp    80106668 <alltraps>
...
80106d90:	6a 00                	push   $0x0
  pushl $21
80106d92:	6a 15                	push   $0x15
  jmp alltraps
80106d94:	e9 cf f8 ff ff       	jmp    80106668 <alltraps>
...
80106d99:	6a 00                	push   $0x0
  pushl $22
80106d9b:	6a 16                	push   $0x16
  jmp alltraps
80106d9d:	e9 c6 f8 ff ff       	jmp    80106668 <alltraps>
...
80106da2:	6a 00                	push   $0x0
  pushl $23
80106da4:	6a 17                	push   $0x17
  jmp alltraps
80106da6:	e9 bd f8 ff ff       	jmp    80106668 <alltraps>
...
80106dab:	6a 00                	push   $0x0
  pushl $24
80106dad:	6a 18                	push   $0x18
  jmp alltraps
80106daf:	e9 b4 f8 ff ff       	jmp    80106668 <alltraps>
...
80106db4:	6a 00                	push   $0x0
  pushl $25
80106db6:	6a 19                	push   $0x19
  jmp alltraps
80106db8:	e9 ab f8 ff ff       	jmp    80106668 <alltraps>
...
80106dbd:	6a 00                	push   $0x0
  pushl $26
80106dbf:	6a 1a                	push   $0x1a
  jmp alltraps
80106dc1:	e9 a2 f8 ff ff       	jmp    80106668 <alltraps>
...
80106dc6:	6a 00                	push   $0x0
  pushl $27
80106dc8:	6a 1b                	push   $0x1b
  jmp alltraps
80106dca:	e9 99 f8 ff ff       	jmp    80106668 <alltraps>
...
80106dcf:	6a 00                	push   $0x0
  pushl $28
80106dd1:	6a 1c                	push   $0x1c
  jmp alltraps
80106dd3:	e9 90 f8 ff ff       	jmp    80106668 <alltraps>
...
80106dd8:	6a 00                	push   $0x0
  pushl $29
80106dda:	6a 1d                	push   $0x1d
  jmp alltraps
80106ddc:	e9 87 f8 ff ff       	jmp    80106668 <alltraps>
...
80106de1:	6a 00                	push   $0x0
  pushl $30
80106de3:	6a 1e                	push   $0x1e
  jmp alltraps
80106de5:	e9 7e f8 ff ff       	jmp    80106668 <alltraps>
...
80106dea:	6a 00                	push   $0x0
  pushl $31
80106dec:	6a 1f                	push   $0x1f
  jmp alltraps
80106dee:	e9 75 f8 ff ff       	jmp    80106668 <alltraps>
...
80106df3:	6a 00                	push   $0x0
  pushl $32
80106df5:	6a 20                	push   $0x20
  jmp alltraps
80106df7:	e9 6c f8 ff ff       	jmp    80106668 <alltraps>
...
80106dfc:	6a 00                	push   $0x0
  pushl $33
80106dfe:	6a 21                	push   $0x21
  jmp alltraps
80106e00:	e9 63 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e05:	6a 00                	push   $0x0
  pushl $34
80106e07:	6a 22                	push   $0x22
  jmp alltraps
80106e09:	e9 5a f8 ff ff       	jmp    80106668 <alltraps>
...
80106e0e:	6a 00                	push   $0x0
  pushl $35
80106e10:	6a 23                	push   $0x23
  jmp alltraps
80106e12:	e9 51 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e17:	6a 00                	push   $0x0
  pushl $36
80106e19:	6a 24                	push   $0x24
  jmp alltraps
80106e1b:	e9 48 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e20:	6a 00                	push   $0x0
  pushl $37
80106e22:	6a 25                	push   $0x25
  jmp alltraps
80106e24:	e9 3f f8 ff ff       	jmp    80106668 <alltraps>
...
80106e29:	6a 00                	push   $0x0
  pushl $38
80106e2b:	6a 26                	push   $0x26
  jmp alltraps
80106e2d:	e9 36 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e32:	6a 00                	push   $0x0
  pushl $39
80106e34:	6a 27                	push   $0x27
  jmp alltraps
80106e36:	e9 2d f8 ff ff       	jmp    80106668 <alltraps>
...
80106e3b:	6a 00                	push   $0x0
  pushl $40
80106e3d:	6a 28                	push   $0x28
  jmp alltraps
80106e3f:	e9 24 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e44:	6a 00                	push   $0x0
  pushl $41
80106e46:	6a 29                	push   $0x29
  jmp alltraps
80106e48:	e9 1b f8 ff ff       	jmp    80106668 <alltraps>
...
80106e4d:	6a 00                	push   $0x0
  pushl $42
80106e4f:	6a 2a                	push   $0x2a
  jmp alltraps
80106e51:	e9 12 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e56:	6a 00                	push   $0x0
  pushl $43
80106e58:	6a 2b                	push   $0x2b
  jmp alltraps
80106e5a:	e9 09 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e5f:	6a 00                	push   $0x0
  pushl $44
80106e61:	6a 2c                	push   $0x2c
  jmp alltraps
80106e63:	e9 00 f8 ff ff       	jmp    80106668 <alltraps>
...
80106e68:	6a 00                	push   $0x0
  pushl $45
80106e6a:	6a 2d                	push   $0x2d
  jmp alltraps
80106e6c:	e9 f7 f7 ff ff       	jmp    80106668 <alltraps>
...
80106e73:	6a 2e                	push   $0x2e
  jmp alltraps
80106e75:	e9 ee f7 ff ff       	jmp    80106668 <alltraps>
...
80106e7a:	6a 00                	push   $0x0
  pushl $47
80106e7c:	6a 2f                	push   $0x2f
  jmp alltraps
80106e7e:	e9 e5 f7 ff ff       	jmp    80106668 <alltraps>
...
80106e83:	6a 00                	push   $0x0
  pushl $48
80106e85:	6a 30                	push   $0x30
  jmp alltraps
80106e87:	e9 dc f7 ff ff       	jmp    80106668 <alltraps>
...
80106e8c:	6a 00                	push   $0x0
  pushl $49
80106e8e:	6a 31                	push   $0x31
  jmp alltraps
80106e90:	e9 d3 f7 ff ff       	jmp    80106668 <alltraps>
...
80106e95:	6a 00                	push   $0x0
  pushl $50
80106e97:	6a 32                	push   $0x32
  jmp alltraps
80106e99:	e9 ca f7 ff ff       	jmp    80106668 <alltraps>
...
80106e9e:	6a 00                	push   $0x0
  pushl $51
80106ea0:	6a 33                	push   $0x33
  jmp alltraps
80106ea2:	e9 c1 f7 ff ff       	jmp    80106668 <alltraps>
...
80106ea7:	6a 00                	push   $0x0
  pushl $52
80106ea9:	6a 34                	push   $0x34
  jmp alltraps
80106eab:	e9 b8 f7 ff ff       	jmp    80106668 <alltraps>
...
80106eb0:	6a 00                	push   $0x0
  pushl $53
80106eb2:	6a 35                	push   $0x35
  jmp alltraps
80106eb4:	e9 af f7 ff ff       	jmp    80106668 <alltraps>
...
80106eb9:	6a 00                	push   $0x0
  pushl $54
80106ebb:	6a 36                	push   $0x36
  jmp alltraps
80106ebd:	e9 a6 f7 ff ff       	jmp    80106668 <alltraps>
...
80106ec2:	6a 00                	push   $0x0
  pushl $55
80106ec4:	6a 37                	push   $0x37
  jmp alltraps
80106ec6:	e9 9d f7 ff ff       	jmp    80106668 <alltraps>
...
80106ecb:	6a 00                	push   $0x0
  pushl $56
80106ecd:	6a 38                	push   $0x38
  jmp alltraps
80106ecf:	e9 94 f7 ff ff       	jmp    80106668 <alltraps>
...
80106ed4:	6a 00                	push   $0x0
  pushl $57
80106ed6:	6a 39                	push   $0x39
  jmp alltraps
80106ed8:	e9 8b f7 ff ff       	jmp    80106668 <alltraps>
...
80106edd:	6a 00                	push   $0x0
  pushl $58
80106edf:	6a 3a                	push   $0x3a
  jmp alltraps
80106ee1:	e9 82 f7 ff ff       	jmp    80106668 <alltraps>
...
80106ee6:	6a 00                	push   $0x0
  pushl $59
80106ee8:	6a 3b                	push   $0x3b
  jmp alltraps
80106eea:	e9 79 f7 ff ff       	jmp    80106668 <alltraps>
...
80106eef:	6a 00                	push   $0x0
  pushl $60
80106ef1:	6a 3c                	push   $0x3c
  jmp alltraps
80106ef3:	e9 70 f7 ff ff       	jmp    80106668 <alltraps>
...
80106ef8:	6a 00                	push   $0x0
  pushl $61
80106efa:	6a 3d                	push   $0x3d
  jmp alltraps
80106efc:	e9 67 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f01:	6a 00                	push   $0x0
  pushl $62
80106f03:	6a 3e                	push   $0x3e
  jmp alltraps
80106f05:	e9 5e f7 ff ff       	jmp    80106668 <alltraps>
...
80106f0a:	6a 00                	push   $0x0
  pushl $63
80106f0c:	6a 3f                	push   $0x3f
  jmp alltraps
80106f0e:	e9 55 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f13:	6a 00                	push   $0x0
  pushl $64
80106f15:	6a 40                	push   $0x40
  jmp alltraps
80106f17:	e9 4c f7 ff ff       	jmp    80106668 <alltraps>
...
80106f1c:	6a 00                	push   $0x0
  pushl $65
80106f1e:	6a 41                	push   $0x41
  jmp alltraps
80106f20:	e9 43 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f25:	6a 00                	push   $0x0
  pushl $66
80106f27:	6a 42                	push   $0x42
  jmp alltraps
80106f29:	e9 3a f7 ff ff       	jmp    80106668 <alltraps>
...
80106f2e:	6a 00                	push   $0x0
  pushl $67
80106f30:	6a 43                	push   $0x43
  jmp alltraps
80106f32:	e9 31 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f37:	6a 00                	push   $0x0
  pushl $68
80106f39:	6a 44                	push   $0x44
  jmp alltraps
80106f3b:	e9 28 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f40:	6a 00                	push   $0x0
  pushl $69
80106f42:	6a 45                	push   $0x45
  jmp alltraps
80106f44:	e9 1f f7 ff ff       	jmp    80106668 <alltraps>
...
80106f49:	6a 00                	push   $0x0
  pushl $70
80106f4b:	6a 46                	push   $0x46
  jmp alltraps
80106f4d:	e9 16 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f52:	6a 00                	push   $0x0
  pushl $71
80106f54:	6a 47                	push   $0x47
  jmp alltraps
80106f56:	e9 0d f7 ff ff       	jmp    80106668 <alltraps>
...
80106f5b:	6a 00                	push   $0x0
  pushl $72
80106f5d:	6a 48                	push   $0x48
  jmp alltraps
80106f5f:	e9 04 f7 ff ff       	jmp    80106668 <alltraps>
...
80106f64:	6a 00                	push   $0x0
  pushl $73
80106f66:	6a 49                	push   $0x49
  jmp alltraps
80106f68:	e9 fb f6 ff ff       	jmp    80106668 <alltraps>
...
80106f6d:	6a 00                	push   $0x0
  pushl $74
80106f6f:	6a 4a                	push   $0x4a
  jmp alltraps
80106f71:	e9 f2 f6 ff ff       	jmp    80106668 <alltraps>
...
80106f76:	6a 00                	push   $0x0
  pushl $75
80106f78:	6a 4b                	push   $0x4b
  jmp alltraps
80106f7a:	e9 e9 f6 ff ff       	jmp    80106668 <alltraps>
...
80106f7f:	6a 00                	push   $0x0
  pushl $76
80106f81:	6a 4c                	push   $0x4c
  jmp alltraps
80106f83:	e9 e0 f6 ff ff       	jmp    80106668 <alltraps>
...
80106f88:	6a 00                	push   $0x0
  pushl $77
80106f8a:	6a 4d                	push   $0x4d
  jmp alltraps
80106f8c:	e9 d7 f6 ff ff       	jmp    80106668 <alltraps>
...
80106f91:	6a 00                	push   $0x0
  pushl $78
80106f93:	6a 4e                	push   $0x4e
  jmp alltraps
80106f95:	e9 ce f6 ff ff       	jmp    80106668 <alltraps>
...
80106f9a:	6a 00                	push   $0x0
  pushl $79
80106f9c:	6a 4f                	push   $0x4f
  jmp alltraps
80106f9e:	e9 c5 f6 ff ff       	jmp    80106668 <alltraps>
...
80106fa3:	6a 00                	push   $0x0
  pushl $80
80106fa5:	6a 50                	push   $0x50
  jmp alltraps
80106fa7:	e9 bc f6 ff ff       	jmp    80106668 <alltraps>
...
80106fac:	6a 00                	push   $0x0
  pushl $81
80106fae:	6a 51                	push   $0x51
  jmp alltraps
80106fb0:	e9 b3 f6 ff ff       	jmp    80106668 <alltraps>
...
80106fb5:	6a 00                	push   $0x0
  pushl $82
80106fb7:	6a 52                	push   $0x52
  jmp alltraps
80106fb9:	e9 aa f6 ff ff       	jmp    80106668 <alltraps>
...
80106fbe:	6a 00                	push   $0x0
  pushl $83
80106fc0:	6a 53                	push   $0x53
  jmp alltraps
80106fc2:	e9 a1 f6 ff ff       	jmp    80106668 <alltraps>
...
80106fc7:	6a 00                	push   $0x0
  pushl $84
80106fc9:	6a 54                	push   $0x54
  jmp alltraps
80106fcb:	e9 98 f6 ff ff       	jmp    80106668 <alltraps>
...
80106fd0:	6a 00                	push   $0x0
  pushl $85
80106fd2:	6a 55                	push   $0x55
  jmp alltraps
80106fd4:	e9 8f f6 ff ff       	jmp    80106668 <alltraps>
...
80106fd9:	6a 00                	push   $0x0
  pushl $86
80106fdb:	6a 56                	push   $0x56
  jmp alltraps
80106fdd:	e9 86 f6 ff ff       	jmp    80106668 <alltraps>
...
80106fe2:	6a 00                	push   $0x0
  pushl $87
80106fe4:	6a 57                	push   $0x57
  jmp alltraps
80106fe6:	e9 7d f6 ff ff       	jmp    80106668 <alltraps>
...
80106feb:	6a 00                	push   $0x0
  pushl $88
80106fed:	6a 58                	push   $0x58
  jmp alltraps
80106fef:	e9 74 f6 ff ff       	jmp    80106668 <alltraps>
...
80106ff4:	6a 00                	push   $0x0
  pushl $89
80106ff6:	6a 59                	push   $0x59
  jmp alltraps
80106ff8:	e9 6b f6 ff ff       	jmp    80106668 <alltraps>
...
80106ffd:	6a 00                	push   $0x0
  pushl $90
80106fff:	6a 5a                	push   $0x5a
  jmp alltraps
80107001:	e9 62 f6 ff ff       	jmp    80106668 <alltraps>
...
80107006:	6a 00                	push   $0x0
  pushl $91
80107008:	6a 5b                	push   $0x5b
  jmp alltraps
8010700a:	e9 59 f6 ff ff       	jmp    80106668 <alltraps>
...
8010700f:	6a 00                	push   $0x0
  pushl $92
80107011:	6a 5c                	push   $0x5c
  jmp alltraps
80107013:	e9 50 f6 ff ff       	jmp    80106668 <alltraps>
...
80107018:	6a 00                	push   $0x0
  pushl $93
8010701a:	6a 5d                	push   $0x5d
  jmp alltraps
8010701c:	e9 47 f6 ff ff       	jmp    80106668 <alltraps>
...
80107021:	6a 00                	push   $0x0
  pushl $94
80107023:	6a 5e                	push   $0x5e
  jmp alltraps
80107025:	e9 3e f6 ff ff       	jmp    80106668 <alltraps>
...
8010702a:	6a 00                	push   $0x0
  pushl $95
8010702c:	6a 5f                	push   $0x5f
  jmp alltraps
8010702e:	e9 35 f6 ff ff       	jmp    80106668 <alltraps>
...
80107033:	6a 00                	push   $0x0
  pushl $96
80107035:	6a 60                	push   $0x60
  jmp alltraps
80107037:	e9 2c f6 ff ff       	jmp    80106668 <alltraps>
...
8010703c:	6a 00                	push   $0x0
  pushl $97
8010703e:	6a 61                	push   $0x61
  jmp alltraps
80107040:	e9 23 f6 ff ff       	jmp    80106668 <alltraps>
...
80107045:	6a 00                	push   $0x0
  pushl $98
80107047:	6a 62                	push   $0x62
  jmp alltraps
80107049:	e9 1a f6 ff ff       	jmp    80106668 <alltraps>
...
8010704e:	6a 00                	push   $0x0
  pushl $99
80107050:	6a 63                	push   $0x63
  jmp alltraps
80107052:	e9 11 f6 ff ff       	jmp    80106668 <alltraps>
...
80107057:	6a 00                	push   $0x0
  pushl $100
80107059:	6a 64                	push   $0x64
  jmp alltraps
8010705b:	e9 08 f6 ff ff       	jmp    80106668 <alltraps>
...
80107060:	6a 00                	push   $0x0
  pushl $101
80107062:	6a 65                	push   $0x65
  jmp alltraps
80107064:	e9 ff f5 ff ff       	jmp    80106668 <alltraps>
...
80107069:	6a 00                	push   $0x0
  pushl $102
8010706b:	6a 66                	push   $0x66
  jmp alltraps
8010706d:	e9 f6 f5 ff ff       	jmp    80106668 <alltraps>
...
80107072:	6a 00                	push   $0x0
  pushl $103
80107074:	6a 67                	push   $0x67
  jmp alltraps
80107076:	e9 ed f5 ff ff       	jmp    80106668 <alltraps>
...
8010707b:	6a 00                	push   $0x0
  pushl $104
8010707d:	6a 68                	push   $0x68
  jmp alltraps
8010707f:	e9 e4 f5 ff ff       	jmp    80106668 <alltraps>
...
80107084:	6a 00                	push   $0x0
  pushl $105
80107086:	6a 69                	push   $0x69
  jmp alltraps
80107088:	e9 db f5 ff ff       	jmp    80106668 <alltraps>
...
8010708d:	6a 00                	push   $0x0
  pushl $106
8010708f:	6a 6a                	push   $0x6a
  jmp alltraps
80107091:	e9 d2 f5 ff ff       	jmp    80106668 <alltraps>
...
80107096:	6a 00                	push   $0x0
  pushl $107
80107098:	6a 6b                	push   $0x6b
  jmp alltraps
8010709a:	e9 c9 f5 ff ff       	jmp    80106668 <alltraps>
...
8010709f:	6a 00                	push   $0x0
  pushl $108
801070a1:	6a 6c                	push   $0x6c
  jmp alltraps
801070a3:	e9 c0 f5 ff ff       	jmp    80106668 <alltraps>
...
801070a8:	6a 00                	push   $0x0
  pushl $109
801070aa:	6a 6d                	push   $0x6d
  jmp alltraps
801070ac:	e9 b7 f5 ff ff       	jmp    80106668 <alltraps>
...
801070b1:	6a 00                	push   $0x0
  pushl $110
801070b3:	6a 6e                	push   $0x6e
  jmp alltraps
801070b5:	e9 ae f5 ff ff       	jmp    80106668 <alltraps>
...
801070ba:	6a 00                	push   $0x0
  pushl $111
801070bc:	6a 6f                	push   $0x6f
  jmp alltraps
801070be:	e9 a5 f5 ff ff       	jmp    80106668 <alltraps>
...
801070c3:	6a 00                	push   $0x0
  pushl $112
801070c5:	6a 70                	push   $0x70
  jmp alltraps
801070c7:	e9 9c f5 ff ff       	jmp    80106668 <alltraps>
...
801070cc:	6a 00                	push   $0x0
  pushl $113
801070ce:	6a 71                	push   $0x71
  jmp alltraps
801070d0:	e9 93 f5 ff ff       	jmp    80106668 <alltraps>
...
801070d5:	6a 00                	push   $0x0
  pushl $114
801070d7:	6a 72                	push   $0x72
  jmp alltraps
801070d9:	e9 8a f5 ff ff       	jmp    80106668 <alltraps>
...
801070de:	6a 00                	push   $0x0
  pushl $115
801070e0:	6a 73                	push   $0x73
  jmp alltraps
801070e2:	e9 81 f5 ff ff       	jmp    80106668 <alltraps>
...
801070e7:	6a 00                	push   $0x0
  pushl $116
801070e9:	6a 74                	push   $0x74
  jmp alltraps
801070eb:	e9 78 f5 ff ff       	jmp    80106668 <alltraps>
...
801070f0:	6a 00                	push   $0x0
  pushl $117
801070f2:	6a 75                	push   $0x75
  jmp alltraps
801070f4:	e9 6f f5 ff ff       	jmp    80106668 <alltraps>
...
801070f9:	6a 00                	push   $0x0
  pushl $118
801070fb:	6a 76                	push   $0x76
  jmp alltraps
801070fd:	e9 66 f5 ff ff       	jmp    80106668 <alltraps>
...
80107102:	6a 00                	push   $0x0
  pushl $119
80107104:	6a 77                	push   $0x77
  jmp alltraps
80107106:	e9 5d f5 ff ff       	jmp    80106668 <alltraps>
...
8010710b:	6a 00                	push   $0x0
  pushl $120
8010710d:	6a 78                	push   $0x78
  jmp alltraps
8010710f:	e9 54 f5 ff ff       	jmp    80106668 <alltraps>
...
80107114:	6a 00                	push   $0x0
  pushl $121
80107116:	6a 79                	push   $0x79
  jmp alltraps
80107118:	e9 4b f5 ff ff       	jmp    80106668 <alltraps>
...
8010711d:	6a 00                	push   $0x0
  pushl $122
8010711f:	6a 7a                	push   $0x7a
  jmp alltraps
80107121:	e9 42 f5 ff ff       	jmp    80106668 <alltraps>
...
80107126:	6a 00                	push   $0x0
  pushl $123
80107128:	6a 7b                	push   $0x7b
  jmp alltraps
8010712a:	e9 39 f5 ff ff       	jmp    80106668 <alltraps>
...
8010712f:	6a 00                	push   $0x0
  pushl $124
80107131:	6a 7c                	push   $0x7c
  jmp alltraps
80107133:	e9 30 f5 ff ff       	jmp    80106668 <alltraps>
...
80107138:	6a 00                	push   $0x0
  pushl $125
8010713a:	6a 7d                	push   $0x7d
  jmp alltraps
8010713c:	e9 27 f5 ff ff       	jmp    80106668 <alltraps>
...
80107141:	6a 00                	push   $0x0
  pushl $126
80107143:	6a 7e                	push   $0x7e
  jmp alltraps
80107145:	e9 1e f5 ff ff       	jmp    80106668 <alltraps>
...
8010714a:	6a 00                	push   $0x0
  pushl $127
8010714c:	6a 7f                	push   $0x7f
  jmp alltraps
8010714e:	e9 15 f5 ff ff       	jmp    80106668 <alltraps>
...
80107153:	6a 00                	push   $0x0
  pushl $128
80107155:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010715a:	e9 09 f5 ff ff       	jmp    80106668 <alltraps>
...
8010715f:	6a 00                	push   $0x0
  pushl $129
80107161:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107166:	e9 fd f4 ff ff       	jmp    80106668 <alltraps>
...
8010716b:	6a 00                	push   $0x0
  pushl $130
8010716d:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107172:	e9 f1 f4 ff ff       	jmp    80106668 <alltraps>
...
80107177:	6a 00                	push   $0x0
  pushl $131
80107179:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010717e:	e9 e5 f4 ff ff       	jmp    80106668 <alltraps>
...
80107183:	6a 00                	push   $0x0
  pushl $132
80107185:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010718a:	e9 d9 f4 ff ff       	jmp    80106668 <alltraps>
...
8010718f:	6a 00                	push   $0x0
  pushl $133
80107191:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107196:	e9 cd f4 ff ff       	jmp    80106668 <alltraps>
...
8010719b:	6a 00                	push   $0x0
  pushl $134
8010719d:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801071a2:	e9 c1 f4 ff ff       	jmp    80106668 <alltraps>
...
801071a7:	6a 00                	push   $0x0
  pushl $135
801071a9:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801071ae:	e9 b5 f4 ff ff       	jmp    80106668 <alltraps>
...
801071b3:	6a 00                	push   $0x0
  pushl $136
801071b5:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801071ba:	e9 a9 f4 ff ff       	jmp    80106668 <alltraps>
...
801071bf:	6a 00                	push   $0x0
  pushl $137
801071c1:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801071c6:	e9 9d f4 ff ff       	jmp    80106668 <alltraps>
...
801071cb:	6a 00                	push   $0x0
  pushl $138
801071cd:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801071d2:	e9 91 f4 ff ff       	jmp    80106668 <alltraps>
...
801071d7:	6a 00                	push   $0x0
  pushl $139
801071d9:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801071de:	e9 85 f4 ff ff       	jmp    80106668 <alltraps>
...
801071e3:	6a 00                	push   $0x0
  pushl $140
801071e5:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801071ea:	e9 79 f4 ff ff       	jmp    80106668 <alltraps>
...
801071ef:	6a 00                	push   $0x0
  pushl $141
801071f1:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801071f6:	e9 6d f4 ff ff       	jmp    80106668 <alltraps>
...
801071fb:	6a 00                	push   $0x0
  pushl $142
801071fd:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107202:	e9 61 f4 ff ff       	jmp    80106668 <alltraps>
...
80107207:	6a 00                	push   $0x0
  pushl $143
80107209:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010720e:	e9 55 f4 ff ff       	jmp    80106668 <alltraps>
...
80107213:	6a 00                	push   $0x0
  pushl $144
80107215:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010721a:	e9 49 f4 ff ff       	jmp    80106668 <alltraps>
...
8010721f:	6a 00                	push   $0x0
  pushl $145
80107221:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107226:	e9 3d f4 ff ff       	jmp    80106668 <alltraps>
...
8010722b:	6a 00                	push   $0x0
  pushl $146
8010722d:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107232:	e9 31 f4 ff ff       	jmp    80106668 <alltraps>
...
80107237:	6a 00                	push   $0x0
  pushl $147
80107239:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010723e:	e9 25 f4 ff ff       	jmp    80106668 <alltraps>
...
80107243:	6a 00                	push   $0x0
  pushl $148
80107245:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010724a:	e9 19 f4 ff ff       	jmp    80106668 <alltraps>
...
8010724f:	6a 00                	push   $0x0
  pushl $149
80107251:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107256:	e9 0d f4 ff ff       	jmp    80106668 <alltraps>
...
8010725b:	6a 00                	push   $0x0
  pushl $150
8010725d:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107262:	e9 01 f4 ff ff       	jmp    80106668 <alltraps>
...
80107267:	6a 00                	push   $0x0
  pushl $151
80107269:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010726e:	e9 f5 f3 ff ff       	jmp    80106668 <alltraps>
...
80107273:	6a 00                	push   $0x0
  pushl $152
80107275:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010727a:	e9 e9 f3 ff ff       	jmp    80106668 <alltraps>
...
8010727f:	6a 00                	push   $0x0
  pushl $153
80107281:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107286:	e9 dd f3 ff ff       	jmp    80106668 <alltraps>
...
8010728b:	6a 00                	push   $0x0
  pushl $154
8010728d:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107292:	e9 d1 f3 ff ff       	jmp    80106668 <alltraps>
...
80107297:	6a 00                	push   $0x0
  pushl $155
80107299:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010729e:	e9 c5 f3 ff ff       	jmp    80106668 <alltraps>
...
801072a3:	6a 00                	push   $0x0
  pushl $156
801072a5:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801072aa:	e9 b9 f3 ff ff       	jmp    80106668 <alltraps>
...
801072af:	6a 00                	push   $0x0
  pushl $157
801072b1:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801072b6:	e9 ad f3 ff ff       	jmp    80106668 <alltraps>
...
801072bb:	6a 00                	push   $0x0
  pushl $158
801072bd:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801072c2:	e9 a1 f3 ff ff       	jmp    80106668 <alltraps>
...
801072c7:	6a 00                	push   $0x0
  pushl $159
801072c9:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801072ce:	e9 95 f3 ff ff       	jmp    80106668 <alltraps>
...
801072d3:	6a 00                	push   $0x0
  pushl $160
801072d5:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801072da:	e9 89 f3 ff ff       	jmp    80106668 <alltraps>
...
801072df:	6a 00                	push   $0x0
  pushl $161
801072e1:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801072e6:	e9 7d f3 ff ff       	jmp    80106668 <alltraps>
...
801072eb:	6a 00                	push   $0x0
  pushl $162
801072ed:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801072f2:	e9 71 f3 ff ff       	jmp    80106668 <alltraps>
...
801072f7:	6a 00                	push   $0x0
  pushl $163
801072f9:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801072fe:	e9 65 f3 ff ff       	jmp    80106668 <alltraps>
...
80107303:	6a 00                	push   $0x0
  pushl $164
80107305:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010730a:	e9 59 f3 ff ff       	jmp    80106668 <alltraps>
...
8010730f:	6a 00                	push   $0x0
  pushl $165
80107311:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107316:	e9 4d f3 ff ff       	jmp    80106668 <alltraps>
...
8010731b:	6a 00                	push   $0x0
  pushl $166
8010731d:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107322:	e9 41 f3 ff ff       	jmp    80106668 <alltraps>
...
80107327:	6a 00                	push   $0x0
  pushl $167
80107329:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010732e:	e9 35 f3 ff ff       	jmp    80106668 <alltraps>
...
80107333:	6a 00                	push   $0x0
  pushl $168
80107335:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010733a:	e9 29 f3 ff ff       	jmp    80106668 <alltraps>
...
8010733f:	6a 00                	push   $0x0
  pushl $169
80107341:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107346:	e9 1d f3 ff ff       	jmp    80106668 <alltraps>
...
8010734b:	6a 00                	push   $0x0
  pushl $170
8010734d:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107352:	e9 11 f3 ff ff       	jmp    80106668 <alltraps>
...
80107357:	6a 00                	push   $0x0
  pushl $171
80107359:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010735e:	e9 05 f3 ff ff       	jmp    80106668 <alltraps>
...
80107363:	6a 00                	push   $0x0
  pushl $172
80107365:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010736a:	e9 f9 f2 ff ff       	jmp    80106668 <alltraps>
...
8010736f:	6a 00                	push   $0x0
  pushl $173
80107371:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107376:	e9 ed f2 ff ff       	jmp    80106668 <alltraps>
...
8010737b:	6a 00                	push   $0x0
  pushl $174
8010737d:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107382:	e9 e1 f2 ff ff       	jmp    80106668 <alltraps>
...
80107387:	6a 00                	push   $0x0
  pushl $175
80107389:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010738e:	e9 d5 f2 ff ff       	jmp    80106668 <alltraps>
...
80107393:	6a 00                	push   $0x0
  pushl $176
80107395:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010739a:	e9 c9 f2 ff ff       	jmp    80106668 <alltraps>
...
8010739f:	6a 00                	push   $0x0
  pushl $177
801073a1:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801073a6:	e9 bd f2 ff ff       	jmp    80106668 <alltraps>
...
801073ab:	6a 00                	push   $0x0
  pushl $178
801073ad:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801073b2:	e9 b1 f2 ff ff       	jmp    80106668 <alltraps>
...
801073b7:	6a 00                	push   $0x0
  pushl $179
801073b9:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801073be:	e9 a5 f2 ff ff       	jmp    80106668 <alltraps>
...
801073c3:	6a 00                	push   $0x0
  pushl $180
801073c5:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801073ca:	e9 99 f2 ff ff       	jmp    80106668 <alltraps>
...
801073cf:	6a 00                	push   $0x0
  pushl $181
801073d1:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801073d6:	e9 8d f2 ff ff       	jmp    80106668 <alltraps>
...
801073db:	6a 00                	push   $0x0
  pushl $182
801073dd:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801073e2:	e9 81 f2 ff ff       	jmp    80106668 <alltraps>
...
801073e7:	6a 00                	push   $0x0
  pushl $183
801073e9:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801073ee:	e9 75 f2 ff ff       	jmp    80106668 <alltraps>
...
801073f3:	6a 00                	push   $0x0
  pushl $184
801073f5:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801073fa:	e9 69 f2 ff ff       	jmp    80106668 <alltraps>
...
801073ff:	6a 00                	push   $0x0
  pushl $185
80107401:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107406:	e9 5d f2 ff ff       	jmp    80106668 <alltraps>
...
8010740b:	6a 00                	push   $0x0
  pushl $186
8010740d:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107412:	e9 51 f2 ff ff       	jmp    80106668 <alltraps>
...
80107417:	6a 00                	push   $0x0
  pushl $187
80107419:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010741e:	e9 45 f2 ff ff       	jmp    80106668 <alltraps>
...
80107423:	6a 00                	push   $0x0
  pushl $188
80107425:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010742a:	e9 39 f2 ff ff       	jmp    80106668 <alltraps>
...
8010742f:	6a 00                	push   $0x0
  pushl $189
80107431:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107436:	e9 2d f2 ff ff       	jmp    80106668 <alltraps>
...
8010743b:	6a 00                	push   $0x0
  pushl $190
8010743d:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107442:	e9 21 f2 ff ff       	jmp    80106668 <alltraps>
...
80107447:	6a 00                	push   $0x0
  pushl $191
80107449:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010744e:	e9 15 f2 ff ff       	jmp    80106668 <alltraps>
...
80107453:	6a 00                	push   $0x0
  pushl $192
80107455:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010745a:	e9 09 f2 ff ff       	jmp    80106668 <alltraps>
...
8010745f:	6a 00                	push   $0x0
  pushl $193
80107461:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107466:	e9 fd f1 ff ff       	jmp    80106668 <alltraps>
...
8010746b:	6a 00                	push   $0x0
  pushl $194
8010746d:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107472:	e9 f1 f1 ff ff       	jmp    80106668 <alltraps>
...
80107477:	6a 00                	push   $0x0
  pushl $195
80107479:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010747e:	e9 e5 f1 ff ff       	jmp    80106668 <alltraps>
...
80107483:	6a 00                	push   $0x0
  pushl $196
80107485:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010748a:	e9 d9 f1 ff ff       	jmp    80106668 <alltraps>
...
8010748f:	6a 00                	push   $0x0
  pushl $197
80107491:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107496:	e9 cd f1 ff ff       	jmp    80106668 <alltraps>
...
8010749b:	6a 00                	push   $0x0
  pushl $198
8010749d:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801074a2:	e9 c1 f1 ff ff       	jmp    80106668 <alltraps>
...
801074a7:	6a 00                	push   $0x0
  pushl $199
801074a9:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801074ae:	e9 b5 f1 ff ff       	jmp    80106668 <alltraps>
...
801074b3:	6a 00                	push   $0x0
  pushl $200
801074b5:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801074ba:	e9 a9 f1 ff ff       	jmp    80106668 <alltraps>
...
801074bf:	6a 00                	push   $0x0
  pushl $201
801074c1:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801074c6:	e9 9d f1 ff ff       	jmp    80106668 <alltraps>
...
801074cb:	6a 00                	push   $0x0
  pushl $202
801074cd:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801074d2:	e9 91 f1 ff ff       	jmp    80106668 <alltraps>
...
801074d7:	6a 00                	push   $0x0
  pushl $203
801074d9:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801074de:	e9 85 f1 ff ff       	jmp    80106668 <alltraps>
...
801074e3:	6a 00                	push   $0x0
  pushl $204
801074e5:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801074ea:	e9 79 f1 ff ff       	jmp    80106668 <alltraps>
...
801074ef:	6a 00                	push   $0x0
  pushl $205
801074f1:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801074f6:	e9 6d f1 ff ff       	jmp    80106668 <alltraps>
...
801074fb:	6a 00                	push   $0x0
  pushl $206
801074fd:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107502:	e9 61 f1 ff ff       	jmp    80106668 <alltraps>
...
80107507:	6a 00                	push   $0x0
  pushl $207
80107509:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010750e:	e9 55 f1 ff ff       	jmp    80106668 <alltraps>
...
80107513:	6a 00                	push   $0x0
  pushl $208
80107515:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010751a:	e9 49 f1 ff ff       	jmp    80106668 <alltraps>
...
8010751f:	6a 00                	push   $0x0
  pushl $209
80107521:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107526:	e9 3d f1 ff ff       	jmp    80106668 <alltraps>
...
8010752b:	6a 00                	push   $0x0
  pushl $210
8010752d:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107532:	e9 31 f1 ff ff       	jmp    80106668 <alltraps>
...
80107537:	6a 00                	push   $0x0
  pushl $211
80107539:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
8010753e:	e9 25 f1 ff ff       	jmp    80106668 <alltraps>
...
80107543:	6a 00                	push   $0x0
  pushl $212
80107545:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010754a:	e9 19 f1 ff ff       	jmp    80106668 <alltraps>
...
8010754f:	6a 00                	push   $0x0
  pushl $213
80107551:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107556:	e9 0d f1 ff ff       	jmp    80106668 <alltraps>
...
8010755b:	6a 00                	push   $0x0
  pushl $214
8010755d:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107562:	e9 01 f1 ff ff       	jmp    80106668 <alltraps>
...
80107567:	6a 00                	push   $0x0
  pushl $215
80107569:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
8010756e:	e9 f5 f0 ff ff       	jmp    80106668 <alltraps>
...
80107573:	6a 00                	push   $0x0
  pushl $216
80107575:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010757a:	e9 e9 f0 ff ff       	jmp    80106668 <alltraps>
...
8010757f:	6a 00                	push   $0x0
  pushl $217
80107581:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107586:	e9 dd f0 ff ff       	jmp    80106668 <alltraps>
...
8010758b:	6a 00                	push   $0x0
  pushl $218
8010758d:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107592:	e9 d1 f0 ff ff       	jmp    80106668 <alltraps>
...
80107597:	6a 00                	push   $0x0
  pushl $219
80107599:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
8010759e:	e9 c5 f0 ff ff       	jmp    80106668 <alltraps>
...
801075a3:	6a 00                	push   $0x0
  pushl $220
801075a5:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801075aa:	e9 b9 f0 ff ff       	jmp    80106668 <alltraps>
...
801075af:	6a 00                	push   $0x0
  pushl $221
801075b1:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801075b6:	e9 ad f0 ff ff       	jmp    80106668 <alltraps>
...
801075bb:	6a 00                	push   $0x0
  pushl $222
801075bd:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801075c2:	e9 a1 f0 ff ff       	jmp    80106668 <alltraps>
...
801075c7:	6a 00                	push   $0x0
  pushl $223
801075c9:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801075ce:	e9 95 f0 ff ff       	jmp    80106668 <alltraps>
...
801075d3:	6a 00                	push   $0x0
  pushl $224
801075d5:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801075da:	e9 89 f0 ff ff       	jmp    80106668 <alltraps>
...
801075df:	6a 00                	push   $0x0
  pushl $225
801075e1:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801075e6:	e9 7d f0 ff ff       	jmp    80106668 <alltraps>
...
801075eb:	6a 00                	push   $0x0
  pushl $226
801075ed:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801075f2:	e9 71 f0 ff ff       	jmp    80106668 <alltraps>
...
801075f7:	6a 00                	push   $0x0
  pushl $227
801075f9:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801075fe:	e9 65 f0 ff ff       	jmp    80106668 <alltraps>
...
80107603:	6a 00                	push   $0x0
  pushl $228
80107605:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010760a:	e9 59 f0 ff ff       	jmp    80106668 <alltraps>
...
8010760f:	6a 00                	push   $0x0
  pushl $229
80107611:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107616:	e9 4d f0 ff ff       	jmp    80106668 <alltraps>
...
8010761b:	6a 00                	push   $0x0
  pushl $230
8010761d:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107622:	e9 41 f0 ff ff       	jmp    80106668 <alltraps>
...
80107627:	6a 00                	push   $0x0
  pushl $231
80107629:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
8010762e:	e9 35 f0 ff ff       	jmp    80106668 <alltraps>
...
80107633:	6a 00                	push   $0x0
  pushl $232
80107635:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010763a:	e9 29 f0 ff ff       	jmp    80106668 <alltraps>
...
8010763f:	6a 00                	push   $0x0
  pushl $233
80107641:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107646:	e9 1d f0 ff ff       	jmp    80106668 <alltraps>
...
8010764b:	6a 00                	push   $0x0
  pushl $234
8010764d:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107652:	e9 11 f0 ff ff       	jmp    80106668 <alltraps>
...
80107657:	6a 00                	push   $0x0
  pushl $235
80107659:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
8010765e:	e9 05 f0 ff ff       	jmp    80106668 <alltraps>
...
80107663:	6a 00                	push   $0x0
  pushl $236
80107665:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010766a:	e9 f9 ef ff ff       	jmp    80106668 <alltraps>
...
8010766f:	6a 00                	push   $0x0
  pushl $237
80107671:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107676:	e9 ed ef ff ff       	jmp    80106668 <alltraps>
...
8010767b:	6a 00                	push   $0x0
  pushl $238
8010767d:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107682:	e9 e1 ef ff ff       	jmp    80106668 <alltraps>
...
80107687:	6a 00                	push   $0x0
  pushl $239
80107689:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
8010768e:	e9 d5 ef ff ff       	jmp    80106668 <alltraps>
...
80107693:	6a 00                	push   $0x0
  pushl $240
80107695:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010769a:	e9 c9 ef ff ff       	jmp    80106668 <alltraps>
...
8010769f:	6a 00                	push   $0x0
  pushl $241
801076a1:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801076a6:	e9 bd ef ff ff       	jmp    80106668 <alltraps>
...
801076ab:	6a 00                	push   $0x0
  pushl $242
801076ad:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801076b2:	e9 b1 ef ff ff       	jmp    80106668 <alltraps>
...
801076b7:	6a 00                	push   $0x0
  pushl $243
801076b9:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801076be:	e9 a5 ef ff ff       	jmp    80106668 <alltraps>
...
801076c3:	6a 00                	push   $0x0
  pushl $244
801076c5:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801076ca:	e9 99 ef ff ff       	jmp    80106668 <alltraps>
...
801076cf:	6a 00                	push   $0x0
  pushl $245
801076d1:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801076d6:	e9 8d ef ff ff       	jmp    80106668 <alltraps>
...
801076db:	6a 00                	push   $0x0
  pushl $246
801076dd:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801076e2:	e9 81 ef ff ff       	jmp    80106668 <alltraps>
...
801076e7:	6a 00                	push   $0x0
  pushl $247
801076e9:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801076ee:	e9 75 ef ff ff       	jmp    80106668 <alltraps>
...
801076f3:	6a 00                	push   $0x0
  pushl $248
801076f5:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801076fa:	e9 69 ef ff ff       	jmp    80106668 <alltraps>
...
801076ff:	6a 00                	push   $0x0
  pushl $249
80107701:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107706:	e9 5d ef ff ff       	jmp    80106668 <alltraps>
...
8010770b:	6a 00                	push   $0x0
  pushl $250
8010770d:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107712:	e9 51 ef ff ff       	jmp    80106668 <alltraps>
...
80107717:	6a 00                	push   $0x0
  pushl $251
80107719:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
8010771e:	e9 45 ef ff ff       	jmp    80106668 <alltraps>
...
80107723:	6a 00                	push   $0x0
  pushl $252
80107725:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010772a:	e9 39 ef ff ff       	jmp    80106668 <alltraps>
...
8010772f:	6a 00                	push   $0x0
  pushl $253
80107731:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107736:	e9 2d ef ff ff       	jmp    80106668 <alltraps>
...
8010773b:	6a 00                	push   $0x0
  pushl $254
8010773d:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107742:	e9 21 ef ff ff       	jmp    80106668 <alltraps>
...
80107747:	6a 00                	push   $0x0
  pushl $255
80107749:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
8010774e:	e9 15 ef ff ff       	jmp    80106668 <alltraps>
...
80107756:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80107759:	8b 45 0c             	mov    0xc(%ebp),%eax
8010775c:	83 e8 01             	sub    $0x1,%eax
8010775f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107763:	8b 45 08             	mov    0x8(%ebp),%eax
80107766:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010776a:	8b 45 08             	mov    0x8(%ebp),%eax
8010776d:	c1 e8 10             	shr    $0x10,%eax
80107770:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107774:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107777:	0f 01 10             	lgdtl  (%eax)
}
8010777a:	c9                   	leave  
8010777b:	c3                   	ret    
...
80107785:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("ltr %0" : : "r" (sel));
80107789:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
8010778d:	0f 00 d8             	ltr    %ax
}
80107790:	c9                   	leave  
80107791:	c3                   	ret    
...
8010779b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  asm volatile("movw %0, %%gs" : : "r" (v));
8010779f:	0f b7 45 fc          	movzwl -0x4(%ebp),%eax
801077a3:	8e e8                	mov    %eax,%gs
}
801077a5:	c9                   	leave  
801077a6:	c3                   	ret    
...
801077cf:	53                   	push   %ebx
801077d0:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801077d3:	e8 a0 b6 ff ff       	call   80102e78 <cpunum>
801077d8:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801077de:	05 60 23 11 80       	add    $0x80112360,%eax
801077e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801077e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077e9:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
801077ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077f2:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
801077f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077fb:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801077ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107802:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107806:	83 e2 f0             	and    $0xfffffff0,%edx
80107809:	83 ca 0a             	or     $0xa,%edx
...
8010781f:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107823:	83 e2 9f             	and    $0xffffff9f,%edx
80107826:	88 50 7d             	mov    %dl,0x7d(%eax)
...
80107864:	83 ca 40             	or     $0x40,%edx
80107867:	88 50 7e             	mov    %dl,0x7e(%eax)
8010786a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010786d:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
80107871:	83 ca 80             	or     $0xffffff80,%edx
80107874:	88 50 7e             	mov    %dl,0x7e(%eax)
80107877:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010787a:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010787e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107881:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107888:	ff ff 
8010788a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010788d:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107894:	00 00 
80107896:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107899:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
801078a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801078a3:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
801078aa:	83 e2 f0             	and    $0xfffffff0,%edx
801078ad:	83 ca 02             	or     $0x2,%edx
...
801078d3:	83 e2 9f             	and    $0xffffff9f,%edx
...
8010791f:	83 e2 df             	and    $0xffffffdf,%edx
...
80107951:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107958:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010795b:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107962:	ff ff 
80107964:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107967:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
8010796e:	00 00 
80107970:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107973:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010797a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010797d:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107984:	83 e2 f0             	and    $0xfffffff0,%edx
80107987:	83 ca 0a             	or     $0xa,%edx
...
801079e6:	83 e2 ef             	and    $0xffffffef,%edx
...
801079f9:	83 e2 df             	and    $0xffffffdf,%edx
...
80107a1f:	83 ca 80             	or     $0xffffff80,%edx
80107a22:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107a28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a2b:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107a32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a35:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107a3c:	ff ff 
80107a3e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a41:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107a48:	00 00 
80107a4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a4d:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
80107a54:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107a57:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
...
80107b05:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107b0c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b0f:	05 b4 00 00 00       	add    $0xb4,%eax
80107b14:	89 c3                	mov    %eax,%ebx
80107b16:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b19:	05 b4 00 00 00       	add    $0xb4,%eax
80107b1e:	c1 e8 10             	shr    $0x10,%eax
80107b21:	89 c1                	mov    %eax,%ecx
80107b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b26:	05 b4 00 00 00       	add    $0xb4,%eax
80107b2b:	c1 e8 18             	shr    $0x18,%eax
80107b2e:	89 c2                	mov    %eax,%edx
80107b30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b33:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107b3a:	00 00 
80107b3c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b3f:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107b46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b49:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107b4f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b52:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b59:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b5c:	83 c9 02             	or     $0x2,%ecx
...
80107b82:	83 e1 9f             	and    $0xffffff9f,%ecx
80107b85:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b8e:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
...
80107ba8:	83 e1 f0             	and    $0xfffffff0,%ecx
...
80107bbb:	83 e1 ef             	and    $0xffffffef,%ecx
...
80107bce:	83 e1 df             	and    $0xffffffdf,%ecx
...
80107bf4:	83 c9 80             	or     $0xffffff80,%ecx
80107bf7:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80107bfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c00:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107c06:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c09:	83 c0 70             	add    $0x70,%eax
80107c0c:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107c13:	00 
80107c14:	89 04 24             	mov    %eax,(%esp)
80107c17:	e8 37 fb ff ff       	call   80107753 <lgdt>
  loadgs(SEG_KCPU << 3);
80107c1c:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107c23:	e8 6a fb ff ff       	call   80107792 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107c28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c2b:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107c31:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107c38:	00 00 00 00 
}
80107c3c:	83 c4 24             	add    $0x24,%esp
80107c3f:	5b                   	pop    %ebx
80107c40:	5d                   	pop    %ebp
80107c41:	c3                   	ret    
...
80107c76:	e8 44 fb ff ff       	call   801077bf <p2v>
80107c7b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c7e:	eb 4b                	jmp    80107ccb <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107c80:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107c84:	74 0e                	je     80107c94 <walkpgdir+0x52>
80107c86:	e8 57 ae ff ff       	call   80102ae2 <kalloc>
80107c8b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c8e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107c92:	75 07                	jne    80107c9b <walkpgdir+0x59>
      return 0;
80107c94:	b8 00 00 00 00       	mov    $0x0,%eax
80107c99:	eb 47                	jmp    80107ce2 <walkpgdir+0xa0>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80107c9b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107ca2:	00 
80107ca3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107caa:	00 
80107cab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cae:	89 04 24             	mov    %eax,(%esp)
80107cb1:	e8 7e d4 ff ff       	call   80105134 <memset>
...
80107cbc:	e8 f1 fa ff ff       	call   801077b2 <v2p>
80107cc1:	83 c8 07             	or     $0x7,%eax
80107cc4:	89 c2                	mov    %eax,%edx
80107cc6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107cc9:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107ccb:	8b 45 0c             	mov    0xc(%ebp),%eax
80107cce:	c1 e8 0c             	shr    $0xc,%eax
80107cd1:	25 ff 03 00 00       	and    $0x3ff,%eax
80107cd6:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80107cdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ce0:	01 d0                	add    %edx,%eax
}
80107ce2:	c9                   	leave  
80107ce3:	c3                   	ret    
...
80107ce7:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107cf2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107cf5:	8b 55 0c             	mov    0xc(%ebp),%edx
80107cf8:	8b 45 10             	mov    0x10(%ebp),%eax
80107cfb:	01 d0                	add    %edx,%eax
80107cfd:	83 e8 01             	sub    $0x1,%eax
80107d00:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107d05:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107d08:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107d0f:	00 
...
80107d1d:	e8 20 ff ff ff       	call   80107c42 <walkpgdir>
80107d22:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107d25:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107d29:	75 07                	jne    80107d32 <mappages+0x4e>
      return -1;
80107d2b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107d30:	eb 48                	jmp    80107d7a <mappages+0x96>
    if(*pte & PTE_P)
80107d32:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d35:	8b 00                	mov    (%eax),%eax
80107d37:	83 e0 01             	and    $0x1,%eax
80107d3a:	85 c0                	test   %eax,%eax
80107d3c:	74 0c                	je     80107d4a <mappages+0x66>
      panic("remap");
80107d3e:	c7 04 24 94 8b 10 80 	movl   $0x80108b94,(%esp)
80107d45:	e8 f0 87 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
80107d4a:	8b 45 18             	mov    0x18(%ebp),%eax
80107d4d:	0b 45 14             	or     0x14(%ebp),%eax
80107d50:	83 c8 01             	or     $0x1,%eax
80107d53:	89 c2                	mov    %eax,%edx
80107d55:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107d58:	89 10                	mov    %edx,(%eax)
    if(a == last)
80107d5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d5d:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107d60:	75 08                	jne    80107d6a <mappages+0x86>
      break;
80107d62:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107d68:	eb 10                	jmp    80107d7a <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
      break;
    a += PGSIZE;
80107d6a:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107d71:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107d78:	eb 8e                	jmp    80107d08 <mappages+0x24>
  return 0;
}
80107d7a:	c9                   	leave  
80107d7b:	c3                   	ret    
...
80107d80:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107d83:	e8 5a ad ff ff       	call   80102ae2 <kalloc>
80107d88:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d8b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d8f:	75 0a                	jne    80107d9b <setupkvm+0x1f>
    return 0;
80107d91:	b8 00 00 00 00       	mov    $0x0,%eax
80107d96:	e9 98 00 00 00       	jmp    80107e33 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107d9b:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107da2:	00 
80107da3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107daa:	00 
80107dab:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107dae:	89 04 24             	mov    %eax,(%esp)
80107db1:	e8 7e d3 ff ff       	call   80105134 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107db6:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107dbd:	e8 fd f9 ff ff       	call   801077bf <p2v>
80107dc2:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107dc7:	76 0c                	jbe    80107dd5 <setupkvm+0x59>
    panic("PHYSTOP too high");
80107dc9:	c7 04 24 9a 8b 10 80 	movl   $0x80108b9a,(%esp)
80107dd0:	e8 65 87 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107dd5:	c7 45 f4 a0 b4 10 80 	movl   $0x8010b4a0,-0xc(%ebp)
80107ddc:	eb 49                	jmp    80107e27 <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107dde:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de1:	8b 48 0c             	mov    0xc(%eax),%ecx
80107de4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de7:	8b 50 04             	mov    0x4(%eax),%edx
80107dea:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ded:	8b 58 08             	mov    0x8(%eax),%ebx
80107df0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df3:	8b 40 04             	mov    0x4(%eax),%eax
80107df6:	29 c3                	sub    %eax,%ebx
80107df8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dfb:	8b 00                	mov    (%eax),%eax
80107dfd:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107e01:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107e05:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107e09:	89 44 24 04          	mov    %eax,0x4(%esp)
80107e0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107e10:	89 04 24             	mov    %eax,(%esp)
80107e13:	e8 cc fe ff ff       	call   80107ce4 <mappages>
80107e18:	85 c0                	test   %eax,%eax
80107e1a:	79 07                	jns    80107e23 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107e1c:	b8 00 00 00 00       	mov    $0x0,%eax
80107e21:	eb 10                	jmp    80107e33 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107e23:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107e27:	81 7d f4 e0 b4 10 80 	cmpl   $0x8010b4e0,-0xc(%ebp)
80107e2e:	72 ae                	jb     80107dde <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107e33:	83 c4 34             	add    $0x34,%esp
80107e36:	5b                   	pop    %ebx
80107e37:	5d                   	pop    %ebp
80107e38:	c3                   	ret    
...
80107e3c:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107e3f:	e8 38 ff ff ff       	call   80107d7c <setupkvm>
80107e44:	a3 38 51 11 80       	mov    %eax,0x80115138
  switchkvm();
80107e49:	e8 02 00 00 00       	call   80107e50 <switchkvm>
}
80107e4e:	c9                   	leave  
80107e4f:	c3                   	ret    
...
80107e56:	a1 38 51 11 80       	mov    0x80115138,%eax
80107e5b:	89 04 24             	mov    %eax,(%esp)
80107e5e:	e8 4f f9 ff ff       	call   801077b2 <v2p>
80107e63:	89 04 24             	mov    %eax,(%esp)
80107e66:	e8 3c f9 ff ff       	call   801077a7 <lcr3>
}
80107e6b:	c9                   	leave  
80107e6c:	c3                   	ret    
...
80107e71:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107e74:	e8 bb d1 ff ff       	call   80105034 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107e79:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e7f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e86:	83 c2 08             	add    $0x8,%edx
80107e89:	89 d3                	mov    %edx,%ebx
80107e8b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e92:	83 c2 08             	add    $0x8,%edx
80107e95:	c1 ea 10             	shr    $0x10,%edx
80107e98:	89 d1                	mov    %edx,%ecx
80107e9a:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107ea1:	83 c2 08             	add    $0x8,%edx
80107ea4:	c1 ea 18             	shr    $0x18,%edx
80107ea7:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107eae:	67 00 
80107eb0:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107eb7:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107ebd:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ec4:	83 e1 f0             	and    $0xfffffff0,%ecx
80107ec7:	83 c9 09             	or     $0x9,%ecx
80107eca:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ed0:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ed7:	83 c9 10             	or     $0x10,%ecx
80107eda:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ee0:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ee7:	83 e1 9f             	and    $0xffffff9f,%ecx
80107eea:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ef0:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ef7:	83 c9 80             	or     $0xffffff80,%ecx
80107efa:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107f00:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107f07:	83 e1 f0             	and    $0xfffffff0,%ecx
...
80107f27:	83 e1 df             	and    $0xffffffdf,%ecx
80107f2a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f30:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107f37:	83 c9 40             	or     $0x40,%ecx
80107f3a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f40:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107f47:	83 e1 7f             	and    $0x7f,%ecx
80107f4a:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107f50:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107f56:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f5c:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107f63:	83 e2 ef             	and    $0xffffffef,%edx
80107f66:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107f6c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f72:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107f78:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f7e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107f85:	8b 52 08             	mov    0x8(%edx),%edx
80107f88:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107f8e:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107f91:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107f98:	e8 df f7 ff ff       	call   8010777c <ltr>
  if(p->pgdir == 0)
80107f9d:	8b 45 08             	mov    0x8(%ebp),%eax
80107fa0:	8b 40 04             	mov    0x4(%eax),%eax
80107fa3:	85 c0                	test   %eax,%eax
80107fa5:	75 0c                	jne    80107fb3 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107fa7:	c7 04 24 ab 8b 10 80 	movl   $0x80108bab,(%esp)
80107fae:	e8 87 85 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107fb3:	8b 45 08             	mov    0x8(%ebp),%eax
80107fb6:	8b 40 04             	mov    0x4(%eax),%eax
80107fb9:	89 04 24             	mov    %eax,(%esp)
80107fbc:	e8 f1 f7 ff ff       	call   801077b2 <v2p>
80107fc1:	89 04 24             	mov    %eax,(%esp)
80107fc4:	e8 de f7 ff ff       	call   801077a7 <lcr3>
  popcli();
80107fc9:	e8 aa d0 ff ff       	call   80105078 <popcli>
}
80107fce:	83 c4 14             	add    $0x14,%esp
80107fd1:	5b                   	pop    %ebx
80107fd2:	5d                   	pop    %ebp
80107fd3:	c3                   	ret    
...
80107fd7:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107fda:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107fe1:	76 0c                	jbe    80107fef <inituvm+0x1b>
    panic("inituvm: more than a page");
80107fe3:	c7 04 24 bf 8b 10 80 	movl   $0x80108bbf,(%esp)
80107fea:	e8 4b 85 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107fef:	e8 ee aa ff ff       	call   80102ae2 <kalloc>
...
8010800d:	e8 22 d1 ff ff       	call   80105134 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108012:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108015:	89 04 24             	mov    %eax,(%esp)
80108018:	e8 95 f7 ff ff       	call   801077b2 <v2p>
8010801d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108024:	00 
80108025:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108029:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108030:	00 
80108031:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108038:	00 
80108039:	8b 45 08             	mov    0x8(%ebp),%eax
8010803c:	89 04 24             	mov    %eax,(%esp)
8010803f:	e8 a0 fc ff ff       	call   80107ce4 <mappages>
  memmove(mem, init, sz);
80108044:	8b 45 10             	mov    0x10(%ebp),%eax
80108047:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108058:	e8 a6 d1 ff ff       	call   80105203 <memmove>
}
8010805d:	c9                   	leave  
8010805e:	c3                   	ret    
...
80108063:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;
...
801080ce:	8b 55 18             	mov    0x18(%ebp),%edx
801080d1:	29 c2                	sub    %eax,%edx
801080d3:	89 d0                	mov    %edx,%eax
801080d5:	3d ff 0f 00 00       	cmp    $0xfff,%eax
801080da:	77 0f                	ja     801080eb <loaduvm+0x8c>
      n = sz - i;
801080dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080df:	8b 55 18             	mov    0x18(%ebp),%edx
801080e2:	29 c2                	sub    %eax,%edx
801080e4:	89 d0                	mov    %edx,%eax
801080e6:	89 45 f0             	mov    %eax,-0x10(%ebp)
801080e9:	eb 07                	jmp    801080f2 <loaduvm+0x93>
    else
      n = PGSIZE;
...
80108101:	e8 b9 f6 ff ff       	call   801077bf <p2v>
...
8010811b:	e8 48 9c ff ff       	call   80101d68 <readi>
80108120:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80108123:	74 07                	je     8010812c <loaduvm+0xcd>
      return -1;
80108125:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010812a:	eb 18                	jmp    80108144 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
80108139:	0f 82 4b ff ff ff    	jb     8010808a <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80108181:	e9 8d 00 00 00       	jmp    80108213 <allocuvm+0xc9>
    mem = kalloc();
80108186:	e8 57 a9 ff ff       	call   80102ae2 <kalloc>
8010818b:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
8010818e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108192:	75 2c                	jne    801081c0 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108194:	c7 04 24 1d 8c 10 80 	movl   $0x80108c1d,(%esp)
8010819b:	e8 00 82 ff ff       	call   801003a0 <cprintf>
...
801081d6:	e8 59 cf ff ff       	call   80105134 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
801081db:	8b 45 f0             	mov    -0x10(%ebp),%eax
801081de:	89 04 24             	mov    %eax,(%esp)
801081e1:	e8 cc f5 ff ff       	call   801077b2 <v2p>
...
80108207:	e8 d8 fa ff ff       	call   80107ce4 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108235:	e9 a4 00 00 00       	jmp    801082de <deallocuvm+0xba>
...
8010824a:	e9 80 00 00 00       	jmp    801082cf <deallocuvm+0xab>
...
80108298:	75 0c                	jne    801082a6 <deallocuvm+0x82>
        panic("kfree");
8010829a:	c7 04 24 35 8c 10 80 	movl   $0x80108c35,(%esp)
801082a1:	e8 94 82 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
801082a6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082a9:	89 04 24             	mov    %eax,(%esp)
801082ac:	e8 0e f5 ff ff       	call   801077bf <p2v>
801082b1:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801082b4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801082b7:	89 04 24             	mov    %eax,(%esp)
801082ba:	e8 8a a7 ff ff       	call   80102a49 <kfree>
      *pte = 0;
801082bf:	8b 45 f0             	mov    -0x10(%ebp),%eax
801082c2:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801082d2:	3b 45 0c             	cmp    0xc(%ebp),%eax
801082d5:	0f 82 74 ff ff ff    	jb     8010824f <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801082e3:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801082e6:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801082ea:	75 0c                	jne    801082f8 <freevm+0x18>
    panic("freevm: no pgdir");
801082ec:	c7 04 24 3b 8c 10 80 	movl   $0x80108c3b,(%esp)
801082f3:	e8 42 82 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801082f8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082ff:	00 
80108300:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108307:	80 
80108308:	8b 45 08             	mov    0x8(%ebp),%eax
8010830b:	89 04 24             	mov    %eax,(%esp)
8010830e:	e8 11 ff ff ff       	call   80108224 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108313:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010831a:	eb 48                	jmp    80108364 <freevm+0x84>
    if(pgdir[i] & PTE_P){
8010831c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010831f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80108332:	74 2c                	je     80108360 <freevm+0x80>
      char * v = p2v(PTE_ADDR(pgdir[i]));
80108334:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108337:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
8010836b:	76 af                	jbe    8010831c <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108373:	e8 d1 a6 ff ff       	call   80102a49 <kfree>
}
80108378:	c9                   	leave  
80108379:	c3                   	ret    
...
8010837d:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
8010838b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010838f:	8b 45 08             	mov    0x8(%ebp),%eax
80108392:	89 04 24             	mov    %eax,(%esp)
80108395:	e8 a8 f8 ff ff       	call   80107c42 <walkpgdir>
8010839a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010839d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801083a1:	75 0c                	jne    801083af <clearpteu+0x35>
    panic("clearpteu");
801083a3:	c7 04 24 4c 8c 10 80 	movl   $0x80108c4c,(%esp)
801083aa:	e8 8b 81 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
801083af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801083b2:	8b 00                	mov    (%eax),%eax
801083b4:	83 e0 fb             	and    $0xfffffffb,%eax
...
801083c4:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801083c7:	e8 b0 f9 ff ff       	call   80107d7c <setupkvm>
801083cc:	89 45 f0             	mov    %eax,-0x10(%ebp)
801083cf:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801083d3:	75 0a                	jne    801083df <copyuvm+0x1f>
    return 0;
801083d5:	b8 00 00 00 00       	mov    $0x0,%eax
801083da:	e9 fd 00 00 00       	jmp    801084dc <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801083df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801083e6:	e9 d0 00 00 00       	jmp    801084bb <copyuvm+0xfb>
...
80108400:	e8 3d f8 ff ff       	call   80107c42 <walkpgdir>
80108405:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108408:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010840c:	75 0c                	jne    8010841a <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
8010840e:	c7 04 24 56 8c 10 80 	movl   $0x80108c56,(%esp)
...
80108424:	75 0c                	jne    80108432 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108426:	c7 04 24 70 8c 10 80 	movl   $0x80108c70,(%esp)
...
80108444:	25 ff 0f 00 00       	and    $0xfff,%eax
80108449:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010844c:	e8 91 a6 ff ff       	call   80102ae2 <kalloc>
80108451:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108454:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108458:	75 02                	jne    8010845c <copyuvm+0x9c>
      goto bad;
8010845a:	eb 70                	jmp    801084cc <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010845c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010845f:	89 04 24             	mov    %eax,(%esp)
80108462:	e8 58 f3 ff ff       	call   801077bf <p2v>
80108467:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010846e:	00 
8010846f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108473:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108476:	89 04 24             	mov    %eax,(%esp)
80108479:	e8 85 cd ff ff       	call   80105203 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
8010847e:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108481:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108484:	89 04 24             	mov    %eax,(%esp)
80108487:	e8 26 f3 ff ff       	call   801077b2 <v2p>
8010848c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010848f:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108493:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108497:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010849e:	00 
8010849f:	89 54 24 04          	mov    %edx,0x4(%esp)
801084a3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084a6:	89 04 24             	mov    %eax,(%esp)
801084a9:	e8 36 f8 ff ff       	call   80107ce4 <mappages>
801084ae:	85 c0                	test   %eax,%eax
801084b0:	79 02                	jns    801084b4 <copyuvm+0xf4>
      goto bad;
801084b2:	eb 18                	jmp    801084cc <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
...
801084be:	3b 45 0c             	cmp    0xc(%ebp),%eax
801084c1:	0f 82 24 ff ff ff    	jb     801083eb <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
801084ca:	eb 10                	jmp    801084dc <copyuvm+0x11c>

bad:
  freevm(d);
801084cc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801084cf:	89 04 24             	mov    %eax,(%esp)
801084d2:	e8 09 fe ff ff       	call   801082e0 <freevm>
  return 0;
801084d7:	b8 00 00 00 00       	mov    $0x0,%eax
}
801084dc:	83 c4 44             	add    $0x44,%esp
801084df:	5b                   	pop    %ebx
801084e0:	5d                   	pop    %ebp
801084e1:	c3                   	ret    
...
801084e5:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801084e8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801084ef:	00 
801084f0:	8b 45 0c             	mov    0xc(%ebp),%eax
801084f3:	89 44 24 04          	mov    %eax,0x4(%esp)
801084f7:	8b 45 08             	mov    0x8(%ebp),%eax
801084fa:	89 04 24             	mov    %eax,(%esp)
801084fd:	e8 40 f7 ff ff       	call   80107c42 <walkpgdir>
...
80108538:	e8 82 f2 ff ff       	call   801077bf <p2v>
}
8010853d:	c9                   	leave  
8010853e:	c3                   	ret    
...
80108542:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108545:	8b 45 10             	mov    0x10(%ebp),%eax
80108548:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010854b:	e9 87 00 00 00       	jmp    801085d7 <copyout+0x98>
...
80108568:	e8 75 ff ff ff       	call   801084e2 <uva2ka>
8010856d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108570:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108574:	75 07                	jne    8010857d <copyout+0x3e>
      return -1;
80108576:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010857b:	eb 69                	jmp    801085e6 <copyout+0xa7>
    n = PGSIZE - (va - va0);
8010857d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108580:	8b 55 ec             	mov    -0x14(%ebp),%edx
...
80108595:	76 06                	jbe    8010859d <copyout+0x5e>
      n = len;
80108597:	8b 45 14             	mov    0x14(%ebp),%eax
8010859a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
8010859d:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085a0:	8b 55 0c             	mov    0xc(%ebp),%edx
801085a3:	29 c2                	sub    %eax,%edx
801085a5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801085a8:	01 c2                	add    %eax,%edx
...
801085b8:	89 14 24             	mov    %edx,(%esp)
801085bb:	e8 43 cc ff ff       	call   80105203 <memmove>
    len -= n;
801085c0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085c3:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
801085c6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801085c9:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801085cc:	8b 45 ec             	mov    -0x14(%ebp),%eax
801085cf:	05 00 10 00 00       	add    $0x1000,%eax
801085d4:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801085d7:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801085db:	0f 85 6f ff ff ff    	jne    80108550 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
