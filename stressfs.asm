...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 8f 09 00 	movl   $0x98f,0x4(%esp)
  33:	00 
  ...
  91:	c7 44 24 04 a2 09 00 	movl   $0x9a2,0x4(%esp)
  98:	00 
...
//    printf(fd, "%d\n", i);
 ...
 125:	e8 19 03 00 00       	call   443 <close>
  ...
  printf(1, "read\n");
 12a:	c7 44 24 04 ac 09 00 	movl   $0x9ac,0x4(%esp)
 131:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 55c:	0f b6 80 00 0c 00 00 	movzbl 0xc00(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6b9:	75 09                	jne    6c4 <printf+0x101>
          s = "(null)";
 6bb:	c7 45 f4 b2 09 00 00 	movl   $0x9b2,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 785:	a1 1c 0c 00 00       	mov    0xc1c,%eax
...
free(void *ap)
{
 ...
 850:	a3 1c 0c 00 00       	mov    %eax,0xc1c
}
 855:	c9                   	leave  
 856:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8a3:	e8 ce fe ff ff       	call   776 <free>
  return freep;
 8a8:	a1 1c 0c 00 00       	mov    0xc1c,%eax
}
 8ad:	c9                   	leave  
 8ae:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8c1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8c4:	a1 1c 0c 00 00       	mov    0xc1c,%eax
 8c9:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8cc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8d0:	75 23                	jne    8f5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8d2:	c7 45 f0 14 0c 00 00 	movl   $0xc14,-0x10(%ebp)
 8d9:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8dc:	a3 1c 0c 00 00       	mov    %eax,0xc1c
 8e1:	a1 1c 0c 00 00       	mov    0xc1c,%eax
 8e6:	a3 14 0c 00 00       	mov    %eax,0xc14
    base.s.size = 0;
 8eb:	c7 05 18 0c 00 00 00 	movl   $0x0,0xc18
 8f2:	00 00 00 
  }
 ...
 948:	a3 1c 0c 00 00       	mov    %eax,0xc1c
      return (void*)(p + 1);
 ...
 953:	eb 38                	jmp    98d <malloc+0xde>
    ...
    if(p == freep)
 955:	a1 1c 0c 00 00       	mov    0xc1c,%eax
