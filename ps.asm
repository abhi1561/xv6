...
int main()
{
  ...
  2e:	c7 44 24 04 af 08 00 	movl   $0x8af,0x4(%esp)
  35:	00 
  36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3d:	e8 a1 04 00 00       	call   4e3 <printf>
	for (i=0;i<n;i++)
  ...
  a2:	c7 44 24 04 c7 08 00 	movl   $0x8c7,0x4(%esp)
  a9:	00 
  aa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b1:	e8 2d 04 00 00       	call   4e3 <printf>
        } q[64],*p;
	p=&q[0];
...
putc(int fd, char c)
{
 ...
 424:	e8 32 ff ff ff       	call   35b <write>
}
 429:	c9                   	leave  
 42a:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 5d9:	75 09                	jne    5e4 <printf+0x101>
          s = "(null)";
 5db:	c7 45 f4 d7 08 00 00 	movl   $0x8d7,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 40 0b 00 00       	mov    0xb40,%eax
...
free(void *ap)
{
 ...
 770:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 775:	c9                   	leave  
 776:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 796:	e8 28 fc ff ff       	call   3c3 <sbrk>
...
malloc(uint nbytes)
{
 ...
 868:	a3 40 0b 00 00       	mov    %eax,0xb40
      return (void*)(p + 1);
 ...
 873:	eb 38                	jmp    8ad <malloc+0xde>
    ...
    if(p == freep)
 875:	a1 40 0b 00 00       	mov    0xb40,%eax
