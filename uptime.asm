...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	0f b6 80 50 0a 00 00 	movzbl 0xa50(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 519:	75 09                	jne    524 <printf+0x101>
          s = "(null)";
 51b:	c7 45 f4 03 08 00 00 	movl   $0x803,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e5:	a1 6c 0a 00 00       	mov    0xa6c,%eax
...
free(void *ap)
{
 ...
 6b0:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 6b5:	c9                   	leave  
 6b6:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 703:	e8 ce fe ff ff       	call   5d6 <free>
  return freep;
 708:	a1 6c 0a 00 00       	mov    0xa6c,%eax
}
 70d:	c9                   	leave  
 70e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 732:	c7 45 f0 64 0a 00 00 	movl   $0xa64,-0x10(%ebp)
 739:	8b 45 f0             	mov    -0x10(%ebp),%eax
 73c:	a3 6c 0a 00 00       	mov    %eax,0xa6c
 741:	a1 6c 0a 00 00       	mov    0xa6c,%eax
 746:	a3 64 0a 00 00       	mov    %eax,0xa64
    base.s.size = 0;
 74b:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 752:	00 00 00 
  }
 ...
 7a8:	a3 6c 0a 00 00       	mov    %eax,0xa6c
      return (void*)(p + 1);
 ...
 7b3:	eb 38                	jmp    7ed <malloc+0xde>
    ...
    if(p == freep)
 7b5:	a1 6c 0a 00 00       	mov    0xa6c,%eax
