...
_nother:     file format elf32-i386
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	0f b6 80 64 0a 00 00 	movzbl 0xa64(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 531:	75 09                	jne    53c <printf+0x101>
          s = "(null)";
 533:	c7 45 f4 19 08 00 00 	movl   $0x819,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5fd:	a1 80 0a 00 00       	mov    0xa80,%eax
...
free(void *ap)
{
 ...
 6c8:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 6cd:	c9                   	leave  
 6ce:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 71b:	e8 ce fe ff ff       	call   5ee <free>
  return freep;
 720:	a1 80 0a 00 00       	mov    0xa80,%eax
}
 725:	c9                   	leave  
 726:	c3                   	ret    
